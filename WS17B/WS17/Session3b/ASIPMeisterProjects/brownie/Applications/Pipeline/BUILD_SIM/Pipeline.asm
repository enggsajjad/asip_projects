...
line65:	BRZ %GPR21, $(outer_loop_end-line65-4)
		;   j = array+startIndex;
	LLSI	%GPR21, %GPR22, $2
...
line76:	BRZ %GPR21, $(inner_loop_end-line76-4)
		;     next_j++;
	ADDI	%GPR27, %GPR27, $4
	;     value_next_j = *next_j;
	LW	%GPR29, 0(%GPR27)
...
line84:	BRZ %GPR21, $(endif-line84-4)
		;       *j = value_next_j;
	SW	0(%GPR25), %GPR29
	;       *next_j = value_j;
	SW	0(%GPR27), %GPR28
	...
	ADD	%GPR28, %GPR0, %GPR29
	;   }
line102:	JP $(inner_loop_begin-line102-4)
...
inner_loop_end:
	...
	ADDI	%GPR24, %GPR24, $1
	; }
line110:	JP $(outer_loop_begin-line110-4)
