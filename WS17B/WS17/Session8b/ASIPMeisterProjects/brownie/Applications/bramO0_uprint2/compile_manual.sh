...
${COMPILER_DIR}/brownie32-elf-gcc -S -O0 lib_uart.c -o lib_uart.s
${COMPILER_DIR}/brownie32-elf-gcc -S -O0 loadStoreByte.c -o loadStoreByte.s
${COMPILER_DIR}/brownie32-elf-gcc -S -O0 string.c -o string.s
${COMPILER_DIR}/brownie32-elf-gcc -S -O0 adpcm.c -o adpcm.s
...
${COMPILER_DIR}/brownie32-elf-as -o lib_uart.o lib_uart.s;
${COMPILER_DIR}/brownie32-elf-as -o loadStoreByte.o loadStoreByte.s;
${COMPILER_DIR}/brownie32-elf-as -o string.o string.s;

${COMPILER_DIR}/brownie32-elf-ld -o adpcm -T browtb.x adpcm.o string.o loadStoreByte.o lib_uart.o startup.o handler.o || {
      echo
...
${MKIMG_DIR}/image2mem4.pl TestData.IM TestData.DM > bramO0_uprint2.mem
...
${CP} -r bramO0_uprint2.mem ./BUILD_SIM/.
