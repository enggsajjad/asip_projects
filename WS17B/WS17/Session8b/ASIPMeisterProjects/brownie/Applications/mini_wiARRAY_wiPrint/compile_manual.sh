...
export ISE_DIR=/home/asip04/WS17/Session8b/ASIPMeisterProjects/brownie/ISEUART5f
...
${MKIMG_DIR}/image2mem4.pl TestData.IM TestData.DM > mini_wiARRAY_wiPrint.mem
${MKIMG_DIR}/image2coe.pl TestData.IM TestData.DM
${MKIMG_DIR}/image2mif.pl IM.coe DM.coe

${CP} -r *.mif *.coe *.DM ${ISE_DIR}/.

${CP} -r mini_wiARRAY_wiPrint.mem ./BUILD_FPGA/.
