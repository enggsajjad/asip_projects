...
-- Generated by ASIP Meister 2.3 on 2017/10/05 12:44:51 
----------------------------------------------------------------------
...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w79;
  ...
  signal decout_ctrl_word_ID : std_logic_vector(106 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(78 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(78 downto 0);
...
begin
  ...
  decout_ctrl_word_ID(101 downto 100) <= 
	...
	"00";
  -- UA_MUX08.SEL:
  decout_ctrl_word_ID(99 downto 99) <= 
	...
	"0";
  -- UA_MUX12.SEL:
  decout_ctrl_word_ID(98 downto 96) <= 
  ...
  decout_ctrl_word_ID(89 downto 88) <= 
	...
	"00" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	...
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_NXOR = '1' or
  	decoded_OR = '1' or decoded_SUB = '1' or decoded_SWAP = '1' or
  	decoded_XOR = '1' else
	"00";
  -- UA_MUX24.SEL:
  decout_ctrl_word_ID(87 downto 86) <= 
	"11" when decoded_MINMAX = '1' else 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LB = '1' or decoded_LH = '1' or decoded_LLSI = '1' or
  ...
  decout_ctrl_word_ID(85 downto 84) <= 
	...
	"00";
  -- UA_MUX29.SEL:
  decout_ctrl_word_ID(83 downto 81) <= 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  	or decoded_SH = '1' or decoded_SW = '1' else
  ...
  decout_ctrl_word_ID(80 downto 79) <= 
	...
	"00";
  -- ALU.mode:
  decout_ctrl_word_ID(78 downto 74) <= 
  ...
  decout_ctrl_word_ID(68 downto 68) <= 
	...
	"0";
  -- SFTvar.mode:
  decout_ctrl_word_ID(67 downto 66) <= 
  ...
  decout_ctrl_word_ID(62 downto 62) <= 
	...
	"0";
  -- ALU1.mode:
  decout_ctrl_word_ID(61 downto 57) <= 
  ...
  decout_ctrl_word_ID(56 downto 56) <= 
	...
	"0";
  -- UA_MUX00.SEL:
  decout_ctrl_word_ID(55 downto 54) <= 
  ...
  decout_ctrl_word_ID(32 downto 32) <= 
	...
	"0";
  -- UA_MUX28.SEL:
  decout_ctrl_word_ID(31 downto 28) <= 
	"1101" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1100" when decoded_MINMAX = '1' else 
	"1011" when decoded_NXOR = '1' else 
	"1010" when decoded_EXHW = '1' else 
  ...
  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(78 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(14 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(106);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(105);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(104);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(103 downto 102);
  decout_UA_MUX05_SEL <= decout_ctrl_word_ID(101 downto 100);
  decout_UA_MUX08_SEL <= decout_ctrl_word_ID(99);
  decout_UA_MUX12_SEL <= decout_ctrl_word_ID(98 downto 96);
  decout_UA_MUX14_SEL <= decout_ctrl_word_ID(95 downto 94);
  decout_UA_MUX16_SEL <= decout_ctrl_word_ID(93 downto 92);
  decout_UA_MUX20_SEL <= decout_ctrl_word_ID(91 downto 90);
  decout_UA_MUX22_SEL <= decout_ctrl_word_ID(89 downto 88);
  decout_UA_MUX24_SEL <= decout_ctrl_word_ID(87 downto 86);
  decout_UA_MUX26_SEL <= decout_ctrl_word_ID(85 downto 84);
  decout_UA_MUX29_SEL <= decout_ctrl_word_ID(83 downto 81);
  decout_UA_MUX30_SEL <= decout_ctrl_word_ID(80 downto 79);
  decout_ALU_mode <= decout_ctrl_word_EXE(78 downto 74);
  decout_ALU_cin <= decout_ctrl_word_EXE(73);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(72);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(71);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(70);
  decout_MUL_mode <= decout_ctrl_word_EXE(69);
  decout_DIV_mode <= decout_ctrl_word_EXE(68);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(67 downto 66);
  decout_PC_load <= decout_ctrl_word_EXE(65);
  decout_GPR_status_enb <= decout_ctrl_word_EXE(64);
  decout_EXT8TO32_mode <= decout_ctrl_word_EXE(63);
  decout_EXT16TO32A_mode <= decout_ctrl_word_EXE(62);
  decout_ALU1_mode <= decout_ctrl_word_EXE(61 downto 57);
  decout_ALU1_cin <= decout_ctrl_word_EXE(56);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(55 downto 54);
  decout_UA_MUX02_SEL <= decout_ctrl_word_EXE(53);
  decout_UA_MUX04_SEL <= decout_ctrl_word_EXE(52);
  decout_UA_MUX06_SEL <= decout_ctrl_word_EXE(51);
  decout_UA_MUX07_SEL <= decout_ctrl_word_EXE(50);
  decout_UA_MUX09_SEL <= decout_ctrl_word_EXE(49 downto 46);
  decout_UA_MUX11_SEL <= decout_ctrl_word_EXE(45 downto 42);
  decout_UA_MUX13_SEL <= decout_ctrl_word_EXE(41);
  decout_UA_MUX17_SEL <= decout_ctrl_word_EXE(40 downto 37);
  decout_UA_MUX19_SEL <= decout_ctrl_word_EXE(36 downto 33);
  decout_UA_MUX21_SEL <= decout_ctrl_word_EXE(32);
  decout_UA_MUX28_SEL <= decout_ctrl_word_EXE(31 downto 28);
