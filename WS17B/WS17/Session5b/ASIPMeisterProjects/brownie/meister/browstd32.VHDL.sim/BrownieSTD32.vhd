...
-- Generated by ASIP Meister 2.3 on 2017/10/11 17:20:54 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal bitnot_02 : std_logic_vector(31 downto 0);
  ...
  signal const_32h00003400 : std_logic_vector(31 downto 0);
  signal const_32h00003000 : std_logic_vector(31 downto 0);
  signal const_32h00003800 : std_logic_vector(31 downto 0);
  ...
  signal bitrange31to16_01 : std_logic_vector(15 downto 0);
  ...
  signal ua_preg12_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux15_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux25_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux29_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux14_dout : std_logic_vector(4 downto 0);
  signal ua_mux16_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux26_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux34_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux09_sel : std_logic_vector(4 downto 0);
  signal ua_mux10_sel : std_logic;
  signal ua_mux11_sel : std_logic_vector(4 downto 0);
  signal ua_mux12_sel : std_logic_vector(2 downto 0);
  signal ua_mux13_sel : std_logic;
  signal ua_mux14_sel : std_logic_vector(1 downto 0);
  signal ua_mux15_sel : std_logic;
  signal ua_mux16_sel : std_logic_vector(1 downto 0);
  signal ua_mux17_sel : std_logic_vector(4 downto 0);
  signal ua_mux18_sel : std_logic;
  signal ua_mux19_sel : std_logic_vector(4 downto 0);
  signal ua_mux20_sel : std_logic_vector(1 downto 0);
  signal ua_mux21_sel : std_logic;
  signal ua_mux22_sel : std_logic_vector(1 downto 0);
  signal ua_mux23_sel : std_logic;
  signal ua_mux24_sel : std_logic_vector(1 downto 0);
  signal ua_mux25_sel : std_logic;
  signal ua_mux26_sel : std_logic_vector(1 downto 0);
  signal ua_mux27_sel : std_logic;
  signal ua_mux28_sel : std_logic_vector(4 downto 0);
  signal ua_mux29_sel : std_logic_vector(2 downto 0);
  ...
  signal unused_06 : std_logic;
  signal unused_07 : std_logic_vector(3 downto 0);
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel0 => ua_mux34_dout, 
      w_sel1 => ua_preg09_dout, 
      data_in0 => ua_mux35_dout, 
      data_in1 => ua_preg07_dout, 
      r_sel0 => ua_mux29_dout, 
      r_sel1 => ua_mux30_dout, 
      data_out0 => uf_gpr_data_out0, 
      data_out1 => uf_gpr_data_out1, 
      status_out => uf_gpr_status_out, 
      status_in => ua_mux36_dout, 
      status_enb => uf_gpr_status_enb, 
      flag_in => concat_00, 
      flag_enb => uf_gpr_flag_enb, 
      do_swap => uf_gpr_do_swap, 
      next_bank => unused_05, 
      current_bank => unused_06
    );
  ...
  UA_MUX01 : rtg_mux3to1_w32
    port map (
      SEL => ua_mux01_sel, 
      DIN0 => const_32h00003400, 
      DIN1 => const_32h00003000, 
      DIN2 => uf_alu_result, 
      DOUT => ua_mux01_dout
    );
  ...
  UA_MUX09 : rtg_mux20to1_w32
    port map (
      ...
      DIN17 => concat_14, 
      DIN18 => concat_15, 
      DIN19 => ua_preg00_dout, 
      DOUT => ua_mux09_dout
    );

  UA_MUX10 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux10_sel, 
  ...
  UA_MUX22 : rtg_mux4to1_w5
    port map (
      SEL => ua_mux22_sel, 
      DIN0 => bitrange21to17_00, 
      DIN1 => bitrange10to6_00, 
      DIN2 => bitrange31to27_00, 
      DIN3 => bitrange16to12_00, 
      DOUT => ua_mux22_dout
    );
  ...
  UA_MUX32 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux32_sel, 
      DIN0 => ua_mux02_dout, 
      DIN1 => const_32h00003800, 
      DOUT => ua_mux32_dout
    );

  UA_MUX33 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux33_sel, 
      DIN0 => ua_mux04_dout, 
  ...
  cmpeq_02 <= 
	'1' when ua_preg03_dout = "00000000000000000000000000000000" else 
	'0';
  cmpneq_00 <= 
	'1' when ua_preg03_dout /= "00000000000000000000000000000000" else 
	'0';
  ...
  bitor_01 <= ua_preg06_dout or const_32h00004300;
  bitrange7to0_00 <= ua_preg03_dout(7 downto 0);
  bitrange15to0_01 <= ua_preg03_dout(15 downto 0);
  bitnot_02 <= not uf_alu_result;
  concat_06 <= const_31h00000000 & bitpos3_00;
  cmpneq_01 <= 
	'1' when concat_06 /= "00000000000000000000000000000000" else 
	'0';
  const_5h01 <= "00001";
  bitrange31to16_01 <= ua_preg03_dout(31 downto 16);
  concat_07 <= const_16h0000 & bitrange31to16_01;
  concat_08 <= bitrange15to0_01 & const_16h0000;
  ...
  cmpeq_05 <= 
	'1' when uf_alu_flag = "1100" else 
	'0';
  bitor_03 <= cmpeq_05 or bitor_02;
  concat_09 <= const_31h00000000 & bitor_03;
  cmpeq_06 <= 
	'1' when bitrange2to0_00 = "000" else 
	'0';
  cmpeq_07 <= 
	'1' when uf_alu_flag = "0011" else 
	'0';
  bitor_04 <= cmpeq_06 or cmpeq_07;
  concat_10 <= const_31h00000000 & bitor_04;
  concat_11 <= bitpos3_00 & bitrange1to0_00;
  cmpeq_08 <= 
	'1' when concat_11 = "100" else 
	'0';
  bitor_05 <= cmpeq_06 or cmpeq_08;
  bitor_06 <= cmpeq_07 or bitor_05;
  concat_12 <= const_31h00000000 & bitor_06;
  concat_13 <= const_31h00000000 & cmpeq_05;
  cmpneq_02 <= 
	'1' when uf_alu_flag /= "1100" else 
	'0';
  concat_14 <= const_31h00000000 & cmpneq_02;
  concat_15 <= const_31h00000000 & bitor_02;
  saved_pc_signal <= ua_ctrl_dataout_saved_pc;
  const_32h00003400 <= "00000000000000000011010000000000";
  const_32hffffbcff <= "11111111111111111011110011111111";
  bitand_00 <= uf_dummy_streg_data_out and const_32hffffbcff;
  const_b1 <= '1';
  const_32h00003000 <= "00000000000000000011000000000000";
  const_32h00003800 <= "00000000000000000011100000000000";
  uf_pc_reset <= '0';
