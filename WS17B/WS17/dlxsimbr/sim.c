...
OpInfo opTable[] = {
  ...
  /*  8: */ {OP_ROT, RIFMT}, {OP_BRZ, BRFMT}, {OP_BRNZ, BRFMT}, {OP_JP, JPFMT},
  ...
  /* 48: */ {OP_FORECAST, IIFMT},  {OP_TRAP, RIFMT},  {OP_RES, RIFMT},  {OP_RES, RIFMT},
...
int specialTable[] = {
  ...
  /*  8: 0x08*/ OP_RES,  OP_RES, OP_RES,  OP_CMOV, OP_RES, OP_CADD, OP_MAC,  OP_MAD,
  /* 16: 0x10*/ OP_AND,  OP_OR, OP_XOR, OP_NAND, OP_NOR, OP_SWAP,  OP_SAD16, OP_EGTU,
  /* 24: 0x18*/ OP_ELEU, OP_EGEU,  OP_XCHG,  OP_AVG,  OP_AVGU,  OP_FEX,   OP_MAX,  OP_LOOPFILTER,
  /* 32: 0x20*/ OP_LLS,  OP_LRS, OP_ARS,  OP_IPRED_HDC16X16, OP_IPRED_VDC16X16,  OP_MC_HZ4,    OP_MINMAX,  OP_ADDU,
  /* 40: 0x28*/ OP_SUBU,  OP_EGT,  OP_ELE,  OP_EGE,  OP_HT2X2CR,  OP_HT4X4IL,   OP_SATD4X4,  OP_DCT4X4,
...
char *operationNames[] = {
  ...
  /* 72: */ "BGEU", "MAC", "MAD", "SWAP", "XCHG", "AVG", "AVGU", "FEX",
  /* 80: */ "MAX", "HT2R", "HT4L", "SAT", "DCT", "FRCT", "FLTR", "HDC",
  /* 88: */ "VDC", "HZ4", "SAD", "MMAX", "ROT",  "", "", "",
  /* 96  */ "", "", "", "", "", ""
};
								 ...
								 * breaks found. */
{
    ...
    while (1) {
		...
		case OP_JPL:
			...
			writeRegister(machPtr, R3, INDEX_TO_ADDR(readRegister(machPtr, NEXT_PC_REG, 0)+1), 0);
			/* continue with OP_JP */
		case OP_JP:
