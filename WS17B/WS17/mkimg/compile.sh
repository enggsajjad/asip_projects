...
PWD='/bin/pwd'
  ...
  #${MV} ${COMPILER_TEMP_DIR}/${1%.c}.s ${COMPILER_TEMP_DIR}/${1%.c}.asm
#  ${CP} ${COMPILER_TEMP_DIR}/${1%.c}.s ${COMPILER_TEMP_DIR}/${1%.c}.asm
  ${MKIMG_DIR}/renameLabels.pl ${COMPILER_TEMP_DIR}/${1%.c}.s  ${1%.c} > ${COMPILER_TEMP_DIR}/${1%.c}.s4
  ${MKIMG_DIR}/renameLC.pl     ${COMPILER_TEMP_DIR}/${1%.c}.s4 ${1%.c} > ${COMPILER_TEMP_DIR}/${1%.c}.asm
