...
},"clamp"{type{"R_4I"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"100111"},width{"5","0"}}
},"calculate"{type{"R_4I"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"111001"},width{"5","0"}}
},"shift"{type{"R_4I"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"111111"},width{"5","0"}}
}}},
...
,"calculate"{Mode{"user_mode"},Behavior{"rd = rs0 - rs1;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"shift"{Mode{"user_mode"},Behavior{"rd = rs1;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
}},
...
,"calculate"{variable{"wire[31:0] predictor;
...
,"shift"{variable{"wire[31:0] result;
wire[31:0] source0;
wire[31:0] source1;
wire[31:0] source2;
wire[31:0] inter;"},clk(1){"wire[31:0] inst;
wire[31:0] current_pc;
...
shamt = source2[4:0];
inter = SFT0.srl(source1, shamt);
<result, flag> = ALU0.add(source0, inter);"},
clk(4){""},
clk(5){"null = GPR.write0(rd, result);"}
}
}}
