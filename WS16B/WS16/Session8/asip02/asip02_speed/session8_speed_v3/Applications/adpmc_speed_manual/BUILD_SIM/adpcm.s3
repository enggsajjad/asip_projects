...
L3:
	...
	addi %GPR4, %GPR0, $7	; step = stepsizeTable[0]
	j	L_adpcm_6
	sgt	%GPR27,%GPR1,%GPR0
...
L_adpcm_5:	; writeToAudioOutL( (valpred+signedUnsignedModification) & 0xFFFF)
	sw	0(%GPR22), %GPR24
L_adpcm_6:	; len > 0
	delt	%GPR17, %GPR8, %GPR18, %GPR9
	nop	;;8,12
	nop	;;8,12
	beqz	%GPR27,L_adpcm_24	; len == 0 -> return
	slli	%GPR11,%GPR17,$2	; r11 = delta << 2 (4 byte offset)
	andi	%GPR19,%GPR17,$8	; sign = delta & 8
	andi	%GPR17,%GPR17,$7	; delta = delta & 7
	srai	%GPR20,%GPR4,$3		; vpdiff = step >> 3
	add	%GPR6, %GPR3, %GPR11		; r6 = *indexTable + offset (r11)
	nop
...
L_adpcm_14:
	add	%GPR20,%GPR20,%GPR4		; vpdiff += step
L_adpcm_15:
	sne	%GPR27,%GPR12,%GPR0		; if ( delta & 2 )
	srai	%GPR12,%GPR4,$1		; r12 = step >> 1
	nop	;;8,12
	nop	;;8,12
...
L_adpcm_17:
	...
	srai	%GPR4,%GPR4,$2		; step = step>>2
	nop	;;8,12
	nop	;;8,12
	beqz	%GPR27, L_adpcm_19
	nop
L_adpcm_18:
	add	%GPR20,%GPR20,%GPR4		; vpdiff += step>>2
L_adpcm_19:
	slli	%GPR4,%GPR7,$2		; r4 = index << 2 (4 byte offset)
	addi	%GPR4,%GPR0,$1		; r4_NEXT = 1
	nop
	sign	%GPR5, %GPR5, %GPR20, %GPR19
	add	%GPR24, %GPR2, %GPR4		; r3 = *stepsizeTable[index] (r4_OLD)
	nop	;;1,5
	nop
	clamp	%GPR5, %GPR4, %GPR25
	lw	%GPR4,0(%GPR24)			; step = stepsizeTable[index]
	seq	%GPR27,%GPR9,%GPR0		; if (!bufferstep)
	addi	%GPR1,%GPR1,$-1
	andi	%GPR24,%GPR5,$65535	; valpred &= 0xFFFF
	nop	;;12,16
