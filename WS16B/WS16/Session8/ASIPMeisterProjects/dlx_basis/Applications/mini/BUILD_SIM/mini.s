...
L_adpcm_15:
	...
	nop	;;0,4
				; Automatically 1 NOPs removed by reduceNOPs.sh
	lhi	%GPR3,$( L_adpcm_1	/0x10000)
	nop
	nop
	nop
	ori	%GPR3,%GPR3,$( L_adpcm_1	%0x10000)
	nop	;;4,7
	nop	;;4,7
	nop	;;4,7
	lhi	%GPR11,$0	
	...
	nop	;;23,27
				; Automatically 1 NOPs removed by reduceNOPs.sh
	slt	%GPR27,%GPR7,%GPR12	
	nop	;;27,31
	nop	;;27,31
	nop	;;27,31
				; Automatically 1 NOPs removed by reduceNOPs.sh
	bnez	%GPR27,L_adpcm_16	
	nop
	nop
	nop
				; Automatically 1 NOPs removed by reduceNOPs.sh
...
L_adpcm_19:
	...
	nop	;;6,10
				; Automatically 1 NOPs removed by reduceNOPs.sh
	sne	%GPR27,%GPR12,%GPR13	
	nop	;;10,14
	nop	;;10,14
	nop	;;10,14
				; Automatically 1 NOPs removed by reduceNOPs.sh
	bnez	%GPR27,L_adpcm_20	
	nop
	nop
	nop
				; Automatically 1 NOPs removed by reduceNOPs.sh
...
L_adpcm_23:
	...
	nop	;;4,8
				; Automatically 1 NOPs removed by reduceNOPs.sh
	sne	%GPR27,%GPR4,%GPR12	
	nop	;;8,12
	nop	;;8,12
	nop	;;8,12
				; Automatically 1 NOPs removed by reduceNOPs.sh
	bnez	%GPR27,L_adpcm_24	
	nop
	nop
	nop
				; Automatically 1 NOPs removed by reduceNOPs.sh
...
L_adpcm_32:
	...
	nop	;;12,16
				; Automatically 1 NOPs removed by reduceNOPs.sh
	lw	%GPR5,0(%GPR3)	
	sne	%GPR27,%GPR4,%GPR11	
	nop	;;17,21
	nop	;;17,21
	nop	;;17,21
				; Automatically 1 NOPs removed by reduceNOPs.sh
	bnez	%GPR27,L_adpcm_33	
	nop
	nop
	nop
				; Automatically 1 NOPs removed by reduceNOPs.sh
...
L_adpcm_33:
	...
	lhi	%GPR4, $(40000008/0x10000)
	nop
	nop
	nop
	ori	%GPR4, %GPR4, $(40000008%0x10000)
	nop
	nop
	nop
	sw	0(%GPR4), %GPR3
...
L_adpcm_34:
	...
	lhi	%GPR4, $(40000004/0x10000)
	nop
	nop
	nop
	ori	%GPR4, %GPR4, $(40000004%0x10000)
	nop
	nop
	nop
	sw	0(%GPR4), %GPR3
...
L_adpcm_38:
	...
	lhi	%GPR1,$( L_adpcm_3	/0x10000)
	nop
	nop
	nop
	ori	%GPR1,%GPR1,$( L_adpcm_3	%0x10000)
	nop	;;3,6
	nop	;;3,6
	nop	;;3,6
	lhi	%GPR2,$0	
	...
	sw	-8(%GPR30),%GPR1	
	lhi	%GPR1,$( L_adpcm_4	/0x10000)
	nop
	nop
	nop
	ori	%GPR1,%GPR1,$( L_adpcm_4	%0x10000)
	nop	;;26,31
	nop	;;26,31
	nop	;;26,31
				; Automatically 6 NOPs removed by reduceNOPs.sh
	...
	nop
				; Automatically 1 NOPs removed by reduceNOPs.sh
	lhi	%GPR1,$( L_adpcm_5	/0x10000)
	nop
	nop
	nop
	ori	%GPR1,%GPR1,$( L_adpcm_5	%0x10000)
	nop	;;32,37
	nop	;;32,37
	nop	;;32,37
				; Automatically 6 NOPs removed by reduceNOPs.sh
	...
	nop
				; Automatically 1 NOPs removed by reduceNOPs.sh
	lhi	%GPR1,$( L_adpcm_6	/0x10000)
	nop
	nop
	nop
	ori	%GPR1,%GPR1,$( L_adpcm_6	%0x10000)
	nop	;;40,45
	nop	;;40,45
	nop	;;40,45
				; Automatically 6 NOPs removed by reduceNOPs.sh
