...
<diff_Neg, flag1> = [cond]ALU0.sub(zeros, difference);
diff = (cond) ? diff_Neg : difference;
<result, cout> = ADD0.adc(predictor, diff, cin);"},
clk(4){""},
clk(5){"null = GPR.write0(rd,result);"}
}
}}
