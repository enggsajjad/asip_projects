...
#ifndef lint
/*static char rcsid[] = "$Header: /home/cvs/cvs_repos/dlxsim/dlx/dlxsim/cop0.c,v 1.1.1.2 2004/08/30 09:15:05 sascha Exp $ SPRITE (Berkeley)";*/
#endif
    ...
    register DLX *machPtr;	/* Machine to check for interrupts. */
{
    ...
    writeRegister(machPtr, PC_REG, ADDR_TO_INDEX(VECTOR_ADDRESS), 0 );
    writeRegister(machPtr, NEXT_PC_REG, ADDR_TO_INDEX(VECTOR_ADDRESS)+1, 0 );
}
