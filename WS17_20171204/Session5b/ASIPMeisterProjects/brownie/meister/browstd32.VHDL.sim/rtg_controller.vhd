...
entity rtg_controller is
  port (
    ...
    CTRLOUT_UA_MUX09_SEL : out std_logic_vector(4 downto 0);
    CTRLOUT_UA_MUX10_SEL : out std_logic;
    CTRLOUT_UA_MUX11_SEL : out std_logic_vector(4 downto 0);
    CTRLOUT_UA_MUX12_SEL : out std_logic_vector(2 downto 0);
    CTRLOUT_UA_MUX13_SEL : out std_logic;
    CTRLOUT_UA_MUX14_SEL : out std_logic_vector(1 downto 0);
    CTRLOUT_UA_MUX15_SEL : out std_logic;
    CTRLOUT_UA_MUX16_SEL : out std_logic_vector(1 downto 0);
    CTRLOUT_UA_MUX17_SEL : out std_logic_vector(4 downto 0);
    CTRLOUT_UA_MUX18_SEL : out std_logic;
    CTRLOUT_UA_MUX19_SEL : out std_logic_vector(4 downto 0);
    ...
    CTRLOUT_UA_MUX26_SEL : out std_logic_vector(1 downto 0);
    CTRLOUT_UA_MUX27_SEL : out std_logic;
    CTRLOUT_UA_MUX28_SEL : out std_logic_vector(4 downto 0);
    CTRLOUT_UA_MUX29_SEL : out std_logic_vector(2 downto 0);
...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w84;
  ...
  signal decoded_ELE : std_logic;
  signal decoded_ELEU : std_logic;
  signal decoded_EGT : std_logic;
  signal decoded_EGTU : std_logic;
  signal decoded_EGE : std_logic;
  signal decoded_EGEU : std_logic;
  signal decoded_EEQU : std_logic;
  signal decoded_ENEQU : std_logic;
  signal decoded_ADDUI : std_logic;
  signal decoded_SUBUI : std_logic;
  signal decoded_ELTI : std_logic;
  signal decoded_ELEI : std_logic;
  signal decoded_EGTI : std_logic;
  signal decoded_EGEI : std_logic;
  signal decoded_EEQI : std_logic;
  signal decoded_ENEQI : std_logic;
  ...
  signal decout_UA_MUX09_SEL : std_logic_vector(4 downto 0);
  signal decout_UA_MUX10_SEL : std_logic;
  signal decout_UA_MUX11_SEL : std_logic_vector(4 downto 0);
  signal decout_UA_MUX12_SEL : std_logic_vector(2 downto 0);
  signal decout_UA_MUX13_SEL : std_logic;
  signal decout_UA_MUX14_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX15_SEL : std_logic;
  signal decout_UA_MUX16_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX17_SEL : std_logic_vector(4 downto 0);
  signal decout_UA_MUX18_SEL : std_logic;
  signal decout_UA_MUX19_SEL : std_logic_vector(4 downto 0);
  ...
  signal decout_UA_MUX26_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX27_SEL : std_logic;
  signal decout_UA_MUX28_SEL : std_logic_vector(4 downto 0);
  signal decout_UA_MUX29_SEL : std_logic_vector(2 downto 0);
  signal decout_UA_MUX30_SEL : std_logic_vector(1 downto 0);
  signal decout_ctrl_word_ID : std_logic_vector(111 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(83 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(83 downto 0);
  signal decout_ctrl_word_WB : std_logic_vector(14 downto 0);
  signal decout_ctrl_word_in_WB : std_logic_vector(14 downto 0);
  ...
  signal resctrl_UA_MUX09_SEL_inst : std_logic_vector(4 downto 0);
  signal resctrl_UA_MUX10_SEL_inst : std_logic;
  signal resctrl_UA_MUX11_SEL_inst : std_logic_vector(4 downto 0);
  signal resctrl_UA_MUX12_SEL_inst : std_logic_vector(2 downto 0);
  signal resctrl_UA_MUX13_SEL_inst : std_logic;
  signal resctrl_UA_MUX14_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX15_SEL_inst : std_logic;
  signal resctrl_UA_MUX16_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX17_SEL_inst : std_logic_vector(4 downto 0);
  signal resctrl_UA_MUX18_SEL_inst : std_logic;
  signal resctrl_UA_MUX19_SEL_inst : std_logic_vector(4 downto 0);
  ...
  signal resctrl_UA_MUX26_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX27_SEL_inst : std_logic;
  signal resctrl_UA_MUX28_SEL_inst : std_logic_vector(4 downto 0);
  signal resctrl_UA_MUX29_SEL_inst : std_logic_vector(2 downto 0);
...
begin
  ...
  decoded_NXOR <= 
	...
	'0';
  decoded_BGEU <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "010000" else 
	'0';
  decoded_AVG <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "001" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "00000110" and DATAIN_IR_DATA_OUT(5
	...
	'0';
  decoded_SWAP <= 
	'1' when DATAIN_IR_DATA_OUT(26 downto 22) = "00000" and
  	DATAIN_IR_DATA_OUT(16 downto 6) = "00000000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "010001" else
	'0';
  decoded_MINMAX <= 
  ...
  decoded_ADDU <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "000" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "00000111" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "000001" else
	'0';
  decoded_SUBU <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "000" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "00001000" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "000001" else
	'0';
  decoded_ELE <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "011" and
  ...
  decoded_EGEU <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "011" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "00001001" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "000001" else
	'0';
  decoded_EEQU <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "011" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "00001010" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "000001" else
	'0';
  decoded_ENEQU <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "011" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "00001011" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "000001" else
	'0';
  decoded_ADDUI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "101001" else 
	'0';
  decoded_SUBUI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "101010" else 
	'0';
  decoded_ELTI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "101011" else 
	'0';
  decoded_ELEI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "101100" else 
	'0';
  decoded_EGTI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "101101" else 
	'0';
  decoded_EGEI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "101110" else 
	'0';
  decoded_EEQI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "101111" else 
	'0';
  decoded_ENEQI <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "110000" else 
	'0';
  ...
  decout_ctrl_word_ID(111 downto 111) <= 
	"0" when decoded_ADDUI = '1' or decoded_ANDI = '1' or decoded_EEQI =
  	'1' or decoded_EGEI = '1' or decoded_EGTI = '1' or decoded_ELEI = '1'
  	or decoded_ELTI = '1' or decoded_ENEQI = '1' or decoded_LSOI = '1' or
  	decoded_ORI = '1' or decoded_SUBUI = '1' or decoded_XORI = '1' else
	"1" when decoded_ADDI = '1' or decoded_BGEU = '1' or decoded_BRNZ =
  ...
  decout_ctrl_word_ID(108 downto 107) <= 
	...
	"00" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU =
  	...
  	or decoded_AVG = '1' or decoded_BGEU = '1' or decoded_EEQ = '1' or
  	decoded_EEQI = '1' or decoded_EEQU = '1' or decoded_EGE = '1' or
  	decoded_EGEI = '1' or decoded_EGEU = '1' or decoded_EGT = '1' or
  	decoded_EGTI = '1' or decoded_EGTU = '1' or decoded_ELE = '1' or
  	decoded_ELEI = '1' or decoded_ELEU = '1' or decoded_ELT = '1' or
  	decoded_ELTI = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_ENEQI = '1' or decoded_ENEQU = '1' or decoded_LB = '1' or
  	decoded_LH = '1' or decoded_LW = '1' or decoded_MINMAX = '1' or
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_NXOR = '1' or
  	decoded_OR = '1' or decoded_ORI = '1' or decoded_SB = '1' or decoded_SH
  	= '1' or decoded_SUB = '1' or decoded_SUBI = '1' or decoded_SUBU = '1'
  	or decoded_SUBUI = '1' or decoded_SW = '1' or decoded_XOR = '1' or
  	decoded_XORI = '1' else
	"00";
  -- UA_MUX05.SEL:
  decout_ctrl_word_ID(106 downto 105) <= 
	...
	"01" when decoded_ADDI = '1' or decoded_ADDUI = '1' or decoded_ANDI =
  	'1' or decoded_BRNZ = '1' or decoded_BRZ = '1' or decoded_EEQI = '1' or
  	decoded_EGEI = '1' or decoded_EGTI = '1' or decoded_ELEI = '1' or
  	decoded_ELTI = '1' or decoded_ENEQI = '1' or decoded_LB = '1' or
  	decoded_LH = '1' or decoded_LSOI = '1' or decoded_LW = '1' or
  	decoded_ORI = '1' or decoded_SB = '1' or decoded_SH = '1' or
  	decoded_SUBI = '1' or decoded_SUBUI = '1' or decoded_SW = '1' or
  	decoded_XORI = '1' else
	"00" when decoded_ADD = '1' or decoded_ADDU = '1' or decoded_AND = '1'
  	or decoded_AVG = '1' or decoded_BGEU = '1' or decoded_EEQ = '1' or
  	decoded_EEQU = '1' or decoded_EGE = '1' or decoded_EGEU = '1' or
  	decoded_EGT = '1' or decoded_EGTU = '1' or decoded_ELE = '1' or
  	decoded_ELEU = '1' or decoded_ELT = '1' or decoded_ELTU = '1' or
  	decoded_ENEQ = '1' or decoded_ENEQU = '1' or decoded_MINMAX = '1' or
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_NXOR = '1' or
  	decoded_OR = '1' or decoded_SUB = '1' or decoded_SUBU = '1' or
  	decoded_XOR = '1' else
	"00";
  -- UA_MUX08.SEL:
  decout_ctrl_word_ID(104 downto 104) <= 
	...
	"0";
  -- UA_MUX12.SEL:
  decout_ctrl_word_ID(103 downto 101) <= 
	...
	"001" when decoded_ADDI = '1' or decoded_ADDUI = '1' or decoded_ANDI =
  	'1' or decoded_ARSI = '1' or decoded_BGEU = '1' or decoded_BRNZ = '1'
  	or decoded_BRZ = '1' or decoded_EEQI = '1' or decoded_EGEI = '1' or
  	decoded_EGTI = '1' or decoded_ELEI = '1' or decoded_ELTI = '1' or
  	decoded_ENEQI = '1' or decoded_LB = '1' or decoded_LH = '1' or
  	decoded_LLSI = '1' or decoded_LRSI = '1' or decoded_LSOI = '1' or
  	decoded_LW = '1' or decoded_ORI = '1' or decoded_SUBI = '1' or
  	decoded_SUBUI = '1' or decoded_XORI = '1' else
	"000" when decoded_ADD = '1' or decoded_ADDU = '1' or decoded_AND =
  	'1' or decoded_ARS = '1' or decoded_AVG = '1' or decoded_DIV = '1' or
  	decoded_DIVU = '1' or decoded_EEQ = '1' or decoded_EEQU = '1' or
  	decoded_EGE = '1' or decoded_EGEU = '1' or decoded_EGT = '1' or
  	decoded_EGTU = '1' or decoded_ELE = '1' or decoded_ELEU = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_ENEQU = '1' or decoded_LLS = '1' or decoded_LRS = '1' or
  	decoded_MINMAX = '1' or decoded_MOD = '1' or decoded_MODU = '1' or
  	decoded_MUL = '1' or decoded_NAND = '1' or decoded_NOR = '1' or
  	decoded_NXOR = '1' or decoded_OR = '1' or decoded_SUB = '1' or
  	decoded_SUBU = '1' or decoded_SWAP = '1' or decoded_XOR = '1' else
	"000";
  -- UA_MUX14.SEL:
  decout_ctrl_word_ID(100 downto 99) <= 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ADDUI = '1' or decoded_ANDI =
  	'1' or decoded_ARSI = '1' or decoded_EEQI = '1' or decoded_EGEI = '1'
  	or decoded_EGTI = '1' or decoded_ELEI = '1' or decoded_ELTI = '1' or
  	decoded_ENEQI = '1' or decoded_LLSI = '1' or decoded_LRSI = '1' or
  	decoded_LSOI = '1' or decoded_ORI = '1' or decoded_SUBI = '1' or
  	decoded_SUBUI = '1' or decoded_XORI = '1' else
	"00" when decoded_ADD = '1' or decoded_ADDU = '1' or decoded_AND = '1'
  	or decoded_ARS = '1' or decoded_AVG = '1' or decoded_DIV = '1' or
  	decoded_DIVU = '1' or decoded_EEQ = '1' or decoded_EEQU = '1' or
  	decoded_EGE = '1' or decoded_EGEU = '1' or decoded_EGT = '1' or
  	decoded_EGTU = '1' or decoded_ELE = '1' or decoded_ELEU = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  ...
  decout_ctrl_word_ID(94 downto 93) <= 
	...
	"00" when decoded_ADD = '1' or decoded_ADDU = '1' or decoded_AND = '1'
  	...
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_NXOR = '1' or
  	decoded_OR = '1' or decoded_SUB = '1' or decoded_SUBU = '1' or
  	decoded_SWAP = '1' or decoded_XOR = '1' else
	"00";
  -- UA_MUX24.SEL:
  ...
  decout_ctrl_word_ID(90 downto 89) <= 
	...
	"00";
  -- UA_MUX29.SEL:
  decout_ctrl_word_ID(88 downto 86) <= 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  	or decoded_SH = '1' or decoded_SW = '1' else
	...
	"000";
  -- UA_MUX30.SEL:
  decout_ctrl_word_ID(85 downto 84) <= 
	"10" when decoded_BGEU = '1' else 
	"01" when decoded_SB = '1' or decoded_SH = '1' or decoded_SW = '1'
  	else
	"00" when decoded_ADD = '1' or decoded_ADDU = '1' or decoded_AND = '1'
	...
	"00";
  -- ALU.mode:
  decout_ctrl_word_ID(83 downto 79) <= 
	"00010" when decoded_EEQI = '1' or decoded_EEQU = '1' or decoded_EGEU
  	= '1' or decoded_EGTU = '1' or decoded_ELEU = '1' or decoded_ENEQI =
  	'1' or decoded_ENEQU = '1' or decoded_SUBU = '1' or decoded_SUBUI = '1'
  	else
	"00001" when decoded_ADDU = '1' or decoded_ADDUI = '1' else 
	"10001" when decoded_NXOR = '1' or decoded_XOR = '1' or decoded_XORI =
  	'1' else
	"11000" when decoded_NOR = '1' else 
	"10000" when decoded_LSOI = '1' or decoded_OR = '1' or decoded_ORI =
  	'1' or decoded_SWAP = '1' else
	"11010" when decoded_NAND = '1' else 
	"10010" when decoded_AND = '1' or decoded_ANDI = '1' else 
	"01010" when decoded_BGEU = '1' or decoded_EEQ = '1' or decoded_EGE =
  	'1' or decoded_EGEI = '1' or decoded_EGT = '1' or decoded_EGTI = '1' or
  	decoded_ELE = '1' or decoded_ELEI = '1' or decoded_ELT = '1' or
  	decoded_ELTI = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_MINMAX = '1' or decoded_SUB = '1' or decoded_SUBI = '1' else
	"01001" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AVG =
  	'1' or decoded_BRNZ = '1' or decoded_BRZ = '1' or decoded_JP = '1' or
  	decoded_JPL = '1' or decoded_LB = '1' or decoded_LH = '1' or decoded_LW
  	= '1' or decoded_SB = '1' or decoded_SH = '1' or decoded_SW = '1' else
	"00000";
  -- ALU.cin:
  decout_ctrl_word_ID(78 downto 78) <= 
	"1" when decoded_BGEU = '1' or decoded_EEQ = '1' or decoded_EEQI = '1'
  	or decoded_EEQU = '1' or decoded_EGE = '1' or decoded_EGEI = '1' or
  	decoded_EGEU = '1' or decoded_EGT = '1' or decoded_EGTI = '1' or
  	decoded_EGTU = '1' or decoded_ELE = '1' or decoded_ELEI = '1' or
  	decoded_ELEU = '1' or decoded_ELT = '1' or decoded_ELTI = '1' or
  	decoded_ELTU = '1' or decoded_ENEQ = '1' or decoded_ENEQI = '1' or
  	decoded_ENEQU = '1' or decoded_MINMAX = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' or decoded_SUBU = '1' or decoded_SUBUI = '1' else
	"0" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	or decoded_ADDUI = '1' or decoded_AVG = '1' or decoded_BRNZ = '1' or
  	decoded_BRZ = '1' or decoded_JP = '1' or decoded_JPL = '1' or
  ...
  decout_ctrl_word_ID(77 downto 77) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	or decoded_ADDUI = '1' or decoded_AVG = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' or decoded_SUBU = '1' or decoded_SUBUI = '1' else
	"0";
  -- FWU0.fw1:
  decout_ctrl_word_ID(76 downto 76) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	or decoded_ADDUI = '1' or decoded_AND = '1' or decoded_ANDI = '1' or
  	decoded_ARS = '1' or decoded_ARSI = '1' or decoded_AVG = '1' or
  	...
  	decoded_ELEI = '1' or decoded_ELEU = '1' or decoded_ELT = '1' or
  	decoded_ELTI = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_ENEQI = '1' or decoded_ENEQU = '1' or decoded_EXBW = '1' or
  	decoded_EXHW = '1' or decoded_JPL = '1' or decoded_JPRL = '1' or
  	decoded_LLS = '1' or decoded_LLSI = '1' or decoded_LRS = '1' or
  	decoded_LRSI = '1' or decoded_LSOI = '1' or decoded_MINMAX = '1' or
  	decoded_MOD = '1' or decoded_MODU = '1' or decoded_MUL = '1' or
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_NXOR = '1' or
	...
	"0";
  -- FWU1.fw1:
  decout_ctrl_word_ID(75 downto 75) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	or decoded_ADDUI = '1' or decoded_AND = '1' or decoded_ANDI = '1' or
  	decoded_ARS = '1' or decoded_ARSI = '1' or decoded_AVG = '1' or
  	decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  ...
  decout_ctrl_word_ID(72 downto 71) <= 
	"11" when decoded_ARS = '1' or decoded_ARSI = '1' or decoded_AVG = '1'
  	else
  ...
  decout_ctrl_word_ID(67 downto 67) <= 
	...
	"0";
  -- ALU1.mode:
  decout_ctrl_word_ID(66 downto 62) <= 
	"01001" when decoded_BGEU = '1' else 
	"00000";
  -- ALU1.cin:
  decout_ctrl_word_ID(61 downto 61) <= 
	"0" when decoded_BGEU = '1' else 
	"0";
  -- UA_MUX00.SEL:
  decout_ctrl_word_ID(60 downto 59) <= 
	"10" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_RETI =
  	'1' else
	"00" when decoded_JP = '1' or decoded_JPL = '1' else 
	"00";
  -- UA_MUX02.SEL:
  decout_ctrl_word_ID(58 downto 58) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	or decoded_ADDUI = '1' or decoded_AND = '1' or decoded_ANDI = '1' or
  	decoded_AVG = '1' or decoded_BGEU = '1' or decoded_BRNZ = '1' or
  	decoded_BRZ = '1' or decoded_EEQ = '1' or decoded_EEQI = '1' or
  	decoded_EEQU = '1' or decoded_EGE = '1' or decoded_EGEI = '1' or
  	decoded_EGEU = '1' or decoded_EGT = '1' or decoded_EGTI = '1' or
  	decoded_EGTU = '1' or decoded_ELE = '1' or decoded_ELEI = '1' or
  	decoded_ELEU = '1' or decoded_ELT = '1' or decoded_ELTI = '1' or
  	decoded_ELTU = '1' or decoded_ENEQ = '1' or decoded_ENEQI = '1' or
  	decoded_ENEQU = '1' or decoded_JP = '1' or decoded_JPL = '1' or
  	decoded_LB = '1' or decoded_LH = '1' or decoded_LSOI = '1' or
  	decoded_LW = '1' or decoded_MINMAX = '1' or decoded_NAND = '1' or
  	decoded_NOR = '1' or decoded_NXOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_SB = '1' or decoded_SH = '1' or
  	decoded_SUB = '1' or decoded_SUBI = '1' or decoded_SUBU = '1' or
  	decoded_SUBUI = '1' or decoded_SW = '1' or decoded_XOR = '1' or
  	decoded_XORI = '1' else
  ...
  decout_ctrl_word_ID(56 downto 56) <= 
	"1" when decoded_ARS = '1' or decoded_ARSI = '1' or decoded_LLS = '1'
  	or decoded_LLSI = '1' or decoded_LRS = '1' or decoded_LRSI = '1' else
	"0" when decoded_AVG = '1' else 
	"0";
  -- UA_MUX07.SEL:
  decout_ctrl_word_ID(55 downto 55) <= 
	...
	"0";
  -- UA_MUX09.SEL:
  decout_ctrl_word_ID(54 downto 50) <= 
	"10011" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"10010" when decoded_ELTI = '1' else 
	"10001" when decoded_ENEQI = '1' or decoded_ENEQU = '1' else 
	"10000" when decoded_EEQI = '1' or decoded_EEQU = '1' else 
	"01111" when decoded_EGE = '1' or decoded_EGEI = '1' or decoded_EGEU =
  	'1' else
	"01110" when decoded_EGT = '1' or decoded_EGTI = '1' or decoded_EGTU =
  	'1' else
	"01101" when decoded_ELE = '1' or decoded_ELEI = '1' or decoded_ELEU =
  	'1' else
	"01100" when decoded_MINMAX = '1' else 
	"01011" when decoded_NXOR = '1' else 
	...
	"00100" when decoded_ARS = '1' or decoded_ARSI = '1' or decoded_AVG =
  	'1' or decoded_LLS = '1' or decoded_LLSI = '1' or decoded_LRS = '1' or
  	decoded_LRSI = '1' else
	...
	"00000" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU =
  	'1' or decoded_ADDUI = '1' or decoded_AND = '1' or decoded_ANDI = '1'
  	or decoded_LSOI = '1' or decoded_NAND = '1' or decoded_NOR = '1' or
  	decoded_OR = '1' or decoded_ORI = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' or decoded_SUBU = '1' or decoded_SUBUI = '1' or
  	decoded_SWAP = '1' or decoded_XOR = '1' or decoded_XORI = '1' else
	"00000";
  -- UA_MUX11.SEL:
  decout_ctrl_word_ID(49 downto 45) <= 
	"10011" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"10010" when decoded_ELTI = '1' else 
	"10001" when decoded_ENEQI = '1' or decoded_ENEQU = '1' else 
	"10000" when decoded_EEQI = '1' or decoded_EEQU = '1' else 
  ...
  decout_ctrl_word_ID(44 downto 44) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	...
  	decoded_ELTI = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_ENEQI = '1' or decoded_ENEQU = '1' or decoded_EXBW = '1' or
  	decoded_EXHW = '1' or decoded_LLS = '1' or decoded_LLSI = '1' or
  	decoded_LRS = '1' or decoded_LRSI = '1' or decoded_LSOI = '1' or
  	decoded_MINMAX = '1' or decoded_MOD = '1' or decoded_MODU = '1' or
  	decoded_MUL = '1' or decoded_NAND = '1' or decoded_NOR = '1' or
  	decoded_NXOR = '1' or decoded_OR = '1' or decoded_ORI = '1' or
  	decoded_SUB = '1' or decoded_SUBI = '1' or decoded_SUBU = '1' or
  	decoded_SUBUI = '1' or decoded_SWAP = '1' or decoded_XOR = '1' or
  	decoded_XORI = '1' else
	"0" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"0";
  -- UA_MUX17.SEL:
  decout_ctrl_word_ID(43 downto 39) <= 
	"10011" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"10010" when decoded_ELTI = '1' else 
	"10001" when decoded_ENEQI = '1' or decoded_ENEQU = '1' else 
	"10000" when decoded_EEQI = '1' or decoded_EEQU = '1' else 
	...
	"00000";
  -- UA_MUX19.SEL:
  decout_ctrl_word_ID(38 downto 34) <= 
	"10011" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"10010" when decoded_ELTI = '1' else 
	"10001" when decoded_ENEQI = '1' or decoded_ENEQU = '1' else 
	"10000" when decoded_EEQI = '1' or decoded_EEQU = '1' else 
  ...
  decout_ctrl_word_ID(33 downto 33) <= 
	...
	"0";
  -- UA_MUX28.SEL:
  decout_ctrl_word_ID(32 downto 28) <= 
	"10011" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"10010" when decoded_ELTI = '1' else 
	"10001" when decoded_ENEQI = '1' or decoded_ENEQU = '1' else 
	"10000" when decoded_EEQI = '1' or decoded_EEQU = '1' else 
  ...
  decout_ctrl_word_ID(14 downto 14) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	...
  	decoded_ENEQI = '1' or decoded_ENEQU = '1' or decoded_EXBW = '1' or
  	decoded_EXHW = '1' or decoded_JPL = '1' or decoded_JPRL = '1' or
  	decoded_LB = '1' or decoded_LH = '1' or decoded_LLS = '1' or
  	decoded_LLSI = '1' or decoded_LRS = '1' or decoded_LRSI = '1' or
  	decoded_LSOI = '1' or decoded_LW = '1' or decoded_MINMAX = '1' or
  	decoded_MOD = '1' or decoded_MODU = '1' or decoded_MUL = '1' or
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_NXOR = '1' or
  	decoded_OR = '1' or decoded_ORI = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' or decoded_SUBU = '1' or decoded_SUBUI = '1' or
  ...
  decout_ctrl_word_ID(11 downto 11) <= 
	...
	"0";
  -- DMAU.mode_out:
  decout_ctrl_word_ID(10 downto 9) <= 
  ...
  decout_ctrl_word_ID(5 downto 5) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ADDU = '1'
  	...
  	decoded_ELTI = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_ENEQI = '1' or decoded_ENEQU = '1' or decoded_EXBW = '1' or
  	decoded_EXHW = '1' or decoded_LB = '1' or decoded_LH = '1' or
  	decoded_LLS = '1' or decoded_LLSI = '1' or decoded_LRS = '1' or
  ...
  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(83 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(14 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(111);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(110);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(109);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(108 downto 107);
  decout_UA_MUX05_SEL <= decout_ctrl_word_ID(106 downto 105);
  decout_UA_MUX08_SEL <= decout_ctrl_word_ID(104);
  decout_UA_MUX12_SEL <= decout_ctrl_word_ID(103 downto 101);
  decout_UA_MUX14_SEL <= decout_ctrl_word_ID(100 downto 99);
  decout_UA_MUX16_SEL <= decout_ctrl_word_ID(98 downto 97);
  decout_UA_MUX20_SEL <= decout_ctrl_word_ID(96 downto 95);
  decout_UA_MUX22_SEL <= decout_ctrl_word_ID(94 downto 93);
  decout_UA_MUX24_SEL <= decout_ctrl_word_ID(92 downto 91);
  decout_UA_MUX26_SEL <= decout_ctrl_word_ID(90 downto 89);
  decout_UA_MUX29_SEL <= decout_ctrl_word_ID(88 downto 86);
  decout_UA_MUX30_SEL <= decout_ctrl_word_ID(85 downto 84);
  decout_ALU_mode <= decout_ctrl_word_EXE(83 downto 79);
  decout_ALU_cin <= decout_ctrl_word_EXE(78);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(77);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(76);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(75);
  decout_MUL_mode <= decout_ctrl_word_EXE(74);
  decout_DIV_mode <= decout_ctrl_word_EXE(73);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(72 downto 71);
  decout_PC_load <= decout_ctrl_word_EXE(70);
  decout_GPR_status_enb <= decout_ctrl_word_EXE(69);
  decout_EXT8TO32_mode <= decout_ctrl_word_EXE(68);
  decout_EXT16TO32A_mode <= decout_ctrl_word_EXE(67);
  decout_ALU1_mode <= decout_ctrl_word_EXE(66 downto 62);
  decout_ALU1_cin <= decout_ctrl_word_EXE(61);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(60 downto 59);
  decout_UA_MUX02_SEL <= decout_ctrl_word_EXE(58);
  decout_UA_MUX04_SEL <= decout_ctrl_word_EXE(57);
  decout_UA_MUX06_SEL <= decout_ctrl_word_EXE(56);
  decout_UA_MUX07_SEL <= decout_ctrl_word_EXE(55);
  decout_UA_MUX09_SEL <= decout_ctrl_word_EXE(54 downto 50);
  decout_UA_MUX11_SEL <= decout_ctrl_word_EXE(49 downto 45);
  decout_UA_MUX13_SEL <= decout_ctrl_word_EXE(44);
  decout_UA_MUX17_SEL <= decout_ctrl_word_EXE(43 downto 39);
  decout_UA_MUX19_SEL <= decout_ctrl_word_EXE(38 downto 34);
  decout_UA_MUX21_SEL <= decout_ctrl_word_EXE(33);
  decout_UA_MUX28_SEL <= decout_ctrl_word_EXE(32 downto 28);
  cause_TRAPINT_inst_at_EXE_00 <= decout_ctrl_word_EXE(27);
  ...
  multcyc_MUL_start_c0_inst_EXE <= decout_ctrl_word_EXE(22);
  multcyc_DIV_start_c0_inst_EXE <= decout_ctrl_word_EXE(21);
  ...
  decout_GPR_w_enb0 <= decout_ctrl_word_WB(14);
  decout_FWU0_fw2 <= decout_ctrl_word_WB(13);
  decout_FWU1_fw2 <= decout_ctrl_word_WB(12);
  decout_DMAU_rw_out <= decout_ctrl_word_WB(11);
  decout_DMAU_mode_out <= decout_ctrl_word_WB(10 downto 9);
  decout_DMAU_ext_out <= decout_ctrl_word_WB(8);
  decout_GPR_w_enb1 <= decout_ctrl_word_WB(7);
  decout_UA_MUX10_SEL <= decout_ctrl_word_WB(6);
  decout_UA_MUX15_SEL <= decout_ctrl_word_WB(5);
  decout_UA_MUX18_SEL <= decout_ctrl_word_WB(4);
  decout_UA_MUX23_SEL <= decout_ctrl_word_WB(3);
  decout_UA_MUX25_SEL <= decout_ctrl_word_WB(2);
  decout_UA_MUX27_SEL <= decout_ctrl_word_WB(1);
  ...
  resctrl_PC_load_inst <= 
	...
	'1' when valid_stage_EXE = '1' and ((asgn_PC_load_inst_v0c0_EXE = '1'
  	...
  	CTRLIN_CMPNEQ_00_EXE = '1') or (asgn_PC_load_inst_v0c2_EXE = '1' and
  ...
  resctrl_UA_MUX00_SEL_inst <= 
	"00" when valid_stage_EXE = '1' and ((asgn_UA_MUX00_SEL_inst_v0c0_EXE
  	= '1' and CTRLIN_CMPEQ_02_EXE = '1') or
  	(asgn_UA_MUX00_SEL_inst_v0c1_EXE = '1' and CTRLIN_CMPNEQ_00_EXE = '1'))
  	else
	"01" when valid_stage_EXE = '1' and asgn_UA_MUX00_SEL_inst_v1c0_EXE =
