...
-- Generated by ASIP Meister 2.3 on 2017/10/20 21:07:13 
----------------------------------------------------------------------
...
architecture RTL of rtg_controller is
  ...
  signal decout_ctrl_word_ID : std_logic_vector(110 downto 0);
...
begin
  ...
  decout_ctrl_word_ID(108 downto 108) <= 
	...
	"0";
  -- UA_MUX03.SEL:
  decout_ctrl_word_ID(107 downto 106) <= 
  ...
  decout_ctrl_word_ID(93 downto 92) <= 
	...
	"00";
  -- UA_MUX24.SEL:
  decout_ctrl_word_ID(91 downto 90) <= 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LB = '1' or decoded_LH = '1' or decoded_LLSI = '1' or
  	decoded_LRSI = '1' or decoded_LSOI = '1' or decoded_LW = '1' or
	...
	"00";
  -- UA_MUX26.SEL:
  decout_ctrl_word_ID(89 downto 88) <= 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LB = '1' or decoded_LH = '1' or decoded_LLSI = '1' or
  	decoded_LRSI = '1' or decoded_LSOI = '1' or decoded_LW = '1' or
	...
	"00";
  -- UA_MUX29.SEL:
  decout_ctrl_word_ID(87 downto 85) <= 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  	or decoded_SH = '1' or decoded_SW = '1' else
  ...
  decout_ctrl_word_ID(82 downto 78) <= 
	...
	"01010" when decoded_BGEU = '1' or decoded_EEQ = '1' or decoded_ELT =
  	...
  	or decoded_SUB = '1' or decoded_SUBI = '1' else
  ...
  decout_ctrl_word_ID(66 downto 66) <= 
	...
	"0";
  -- ALU1.mode:
  decout_ctrl_word_ID(65 downto 61) <= 
  ...
  decout_ctrl_word_ID(43 downto 43) <= 
	...
	"0";
  -- UA_MUX17.SEL:
  decout_ctrl_word_ID(42 downto 39) <= 
	"1101" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1100" when decoded_MINMAX = '1' else 
	"1011" when decoded_NXOR = '1' else 
	"1010" when decoded_EXHW = '1' else 
  ...
  decout_ctrl_word_ID(34 downto 34) <= 
	...
	"0";
  -- UA_MUX28.SEL:
  decout_ctrl_word_ID(33 downto 30) <= 
	"1101" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1100" when decoded_MINMAX = '1' else 
	"1011" when decoded_NXOR = '1' else 
	"1010" when decoded_EXHW = '1' else 
  ...
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(110);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(109);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(108);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(107 downto 106);
  decout_UA_MUX05_SEL <= decout_ctrl_word_ID(105 downto 104);
  decout_UA_MUX08_SEL <= decout_ctrl_word_ID(103);
  decout_UA_MUX12_SEL <= decout_ctrl_word_ID(102 downto 100);
  decout_UA_MUX14_SEL <= decout_ctrl_word_ID(99 downto 98);
  decout_UA_MUX16_SEL <= decout_ctrl_word_ID(97 downto 96);
  decout_UA_MUX20_SEL <= decout_ctrl_word_ID(95 downto 94);
  decout_UA_MUX22_SEL <= decout_ctrl_word_ID(93 downto 92);
  decout_UA_MUX24_SEL <= decout_ctrl_word_ID(91 downto 90);
  decout_UA_MUX26_SEL <= decout_ctrl_word_ID(89 downto 88);
  decout_UA_MUX29_SEL <= decout_ctrl_word_ID(87 downto 85);
  decout_UA_MUX30_SEL <= decout_ctrl_word_ID(84 downto 83);
  ...
  decout_ALU1_mode <= decout_ctrl_word_EXE(65 downto 61);
  decout_ALU1_cin <= decout_ctrl_word_EXE(60);
  decout_FWU2_fw1 <= decout_ctrl_word_EXE(59);
  decout_FWU3_fw1 <= decout_ctrl_word_EXE(58);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(57 downto 56);
  decout_UA_MUX02_SEL <= decout_ctrl_word_EXE(55);
  decout_UA_MUX04_SEL <= decout_ctrl_word_EXE(54);
  decout_UA_MUX06_SEL <= decout_ctrl_word_EXE(53);
  decout_UA_MUX07_SEL <= decout_ctrl_word_EXE(52);
  decout_UA_MUX09_SEL <= decout_ctrl_word_EXE(51 downto 48);
  decout_UA_MUX11_SEL <= decout_ctrl_word_EXE(47 downto 44);
  decout_UA_MUX13_SEL <= decout_ctrl_word_EXE(43);
  decout_UA_MUX17_SEL <= decout_ctrl_word_EXE(42 downto 39);
  decout_UA_MUX19_SEL <= decout_ctrl_word_EXE(38 downto 35);
  decout_UA_MUX21_SEL <= decout_ctrl_word_EXE(34);
  decout_UA_MUX28_SEL <= decout_ctrl_word_EXE(33 downto 30);
