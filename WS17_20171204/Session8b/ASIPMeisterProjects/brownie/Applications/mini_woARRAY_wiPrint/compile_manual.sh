...
export COMPILER_DIR=~/SS17/Session5b/ASIPMeisterProjects/brownie/meister/browstd32.swgen/bin
export ISE_DIR=/home/asip04/SS17/Session5b/ASIPMeisterProjects/brownie/ISEUART5f
...
${MKIMG_DIR}/image2mem4.pl TestData.IM TestData.DM > mini_woARRAY_wiPrint.mem
${MKIMG_DIR}/image2coe.pl TestData.IM TestData.DM
${MKIMG_DIR}/image2mif.pl IM.coe DM.coe

${CP} -r *.mif *.coe *.DM ${ISE_DIR}/.

${CP} -r mini_woARRAY_wiPrint.mem ./BUILD_FPGA/.
