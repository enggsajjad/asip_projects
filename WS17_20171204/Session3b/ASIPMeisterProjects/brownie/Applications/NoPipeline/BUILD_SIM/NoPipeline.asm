...
line66:	BRZ %GPR21, $(outer_loop_end-line66-4)
	NOP
	;   j = array+startIndex;
	LLSI	%GPR21, %GPR22, $2
...
line78:	BRZ %GPR21, $(inner_loop_end-line78-4)
	NOP
	;     next_j++;
	ADDI	%GPR27, %GPR27, $4
	;     value_next_j = *next_j;
...
line86:	BRZ %GPR21, $(endif-line86-4)
	NOP
	;       *j = value_next_j;
	SW	0(%GPR25), %GPR29
	;       *next_j = value_j;
	...
	ADD	%GPR28, %GPR0, %GPR29
	;   }
line105:	JP $(inner_loop_begin-line105-4)
	NOP
inner_loop_end:
	;   innerLoopEnd--;
	SUBI	%GPR26, %GPR26, $4
	...
	ADDI	%GPR24, %GPR24, $1
	; }
line113:	JP $(outer_loop_begin-line113-4)
	NOP
outer_loop_end:
