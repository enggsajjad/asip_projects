...
-- Generated by ASIP Meister 2.3 on 2017/10/04 14:09:23 
----------------------------------------------------------------------
...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w74;
  ...
  signal decout_ctrl_word_ID : std_logic_vector(101 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(73 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(73 downto 0);
...
begin
  ...
  decout_ctrl_word_ID(101 downto 101) <= 
	...
	"0";
  -- EXT26TO32.mode:
  decout_ctrl_word_ID(100 downto 100) <= 
  ...
  decout_ctrl_word_ID(98 downto 97) <= 
	...
	"00" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	or decoded_ANDI = '1' or decoded_BGEU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1' or
  ...
  decout_ctrl_word_ID(96 downto 95) <= 
	...
	"00" when decoded_ADD = '1' or decoded_AND = '1' or decoded_BGEU = '1'
  	or decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ELTU = '1' or
  	decoded_ENEQ = '1' or decoded_NAND = '1' or decoded_NOR = '1' or
  ...
  decout_ctrl_word_ID(80 downto 79) <= 
	...
	"00";
  -- UA_MUX25.SEL:
  decout_ctrl_word_ID(78 downto 76) <= 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  	or decoded_SH = '1' or decoded_SW = '1' else
  ...
  decout_ctrl_word_ID(75 downto 74) <= 
	...
	"00";
  -- ALU.mode:
  decout_ctrl_word_ID(73 downto 69) <= 
	...
	"01010" when decoded_BGEU = '1' or decoded_EEQ = '1' or decoded_ELT =
  	'1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' else
  ...
  decout_ctrl_word_ID(68 downto 68) <= 
	"1" when decoded_BGEU = '1' or decoded_EEQ = '1' or decoded_ELT = '1'
  	or decoded_ELTU = '1' or decoded_ENEQ = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' else
  ...
  decout_ctrl_word_ID(57 downto 57) <= 
	...
	"0";
  -- ALU1.mode:
  decout_ctrl_word_ID(56 downto 52) <= 
  ...
  decout_ctrl_word_ID(40 downto 40) <= 
	...
	"0";
  -- UA_MUX13.SEL:
  decout_ctrl_word_ID(39 downto 36) <= 
	"1100" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1011" when decoded_NXOR = '1' else 
	"1010" when decoded_EXHW = '1' else 
	"1001" when decoded_EXBW = '1' else 
  ...
  decout_ctrl_word_ID(31 downto 31) <= 
	...
	"0";
  -- UA_MUX24.SEL:
  decout_ctrl_word_ID(30 downto 27) <= 
	"1100" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1011" when decoded_NXOR = '1' else 
	"1010" when decoded_EXHW = '1' else 
	"1001" when decoded_EXBW = '1' else 
  ...
  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(73 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(13 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(101);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(100);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(99);
  decout_UA_MUX02_SEL <= decout_ctrl_word_ID(98 downto 97);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(96 downto 95);
  decout_UA_MUX04_SEL <= decout_ctrl_word_ID(94);
  decout_UA_MUX08_SEL <= decout_ctrl_word_ID(93 downto 91);
  decout_UA_MUX10_SEL <= decout_ctrl_word_ID(90 downto 89);
  decout_UA_MUX12_SEL <= decout_ctrl_word_ID(88 downto 87);
  decout_UA_MUX16_SEL <= decout_ctrl_word_ID(86 downto 85);
  decout_UA_MUX18_SEL <= decout_ctrl_word_ID(84 downto 83);
  decout_UA_MUX20_SEL <= decout_ctrl_word_ID(82 downto 81);
  decout_UA_MUX22_SEL <= decout_ctrl_word_ID(80 downto 79);
  decout_UA_MUX25_SEL <= decout_ctrl_word_ID(78 downto 76);
  decout_UA_MUX26_SEL <= decout_ctrl_word_ID(75 downto 74);
  decout_ALU_mode <= decout_ctrl_word_EXE(73 downto 69);
  decout_ALU_cin <= decout_ctrl_word_EXE(68);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(67);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(66);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(65);
  decout_MUL_mode <= decout_ctrl_word_EXE(64);
  decout_DIV_mode <= decout_ctrl_word_EXE(63);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(62 downto 61);
  decout_PC_load <= decout_ctrl_word_EXE(60);
  decout_GPR_status_enb <= decout_ctrl_word_EXE(59);
  decout_EXT8TO32_mode <= decout_ctrl_word_EXE(58);
  decout_EXT16TO32A_mode <= decout_ctrl_word_EXE(57);
  decout_ALU1_mode <= decout_ctrl_word_EXE(56 downto 52);
  decout_ALU1_cin <= decout_ctrl_word_EXE(51);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(50 downto 49);
  decout_UA_MUX05_SEL <= decout_ctrl_word_EXE(48 downto 45);
  decout_UA_MUX07_SEL <= decout_ctrl_word_EXE(44 downto 41);
  decout_UA_MUX09_SEL <= decout_ctrl_word_EXE(40);
  decout_UA_MUX13_SEL <= decout_ctrl_word_EXE(39 downto 36);
  decout_UA_MUX15_SEL <= decout_ctrl_word_EXE(35 downto 32);
  decout_UA_MUX17_SEL <= decout_ctrl_word_EXE(31);
  decout_UA_MUX24_SEL <= decout_ctrl_word_EXE(30 downto 27);
  cause_TRAPINT_inst_at_EXE_00 <= decout_ctrl_word_EXE(26);
  ...
  multcyc_MUL_start_c0_inst_EXE <= decout_ctrl_word_EXE(21);
  multcyc_DIV_start_c0_inst_EXE <= decout_ctrl_word_EXE(20);
