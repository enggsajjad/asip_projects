...
-- Generated by ASIP Meister 2.3 on 2017/10/04 14:09:33 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal ua_mux23_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_mux05_sel : std_logic_vector(3 downto 0);
  signal ua_mux06_sel : std_logic;
  signal ua_mux07_sel : std_logic_vector(3 downto 0);
  ...
  signal ua_mux13_sel : std_logic_vector(3 downto 0);
  signal ua_mux14_sel : std_logic;
  signal ua_mux15_sel : std_logic_vector(3 downto 0);
  ...
  signal ua_mux24_sel : std_logic_vector(3 downto 0);
  signal ua_mux25_sel : std_logic_vector(2 downto 0);
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel0 => ua_mux30_dout, 
      data_in0 => ua_mux31_dout, 
      r_sel0 => ua_mux25_dout, 
      r_sel1 => ua_mux26_dout, 
      data_out0 => uf_gpr_data_out0, 
      data_out1 => uf_gpr_data_out1, 
      status_out => uf_gpr_status_out, 
      status_in => ua_mux32_dout, 
