...
#ifndef lint
static char rcsid[] = "$Header: /home/cvs/cvs_repos/dlxsim/dlx/dlxsim/tcl/tclCmdAH.c,v 1.1.1.2 2004/08/30 09:15:06 sascha Exp $ SPRITE (Berkeley)";
#endif
    ...
    char **argv;			/* Argument strings. */
{
	...
	if (!execSignalled) {
	    select(maxID+1, &readMask, &writeMask, (fd_set*)NULL, &timeout);
	}
    }
    output[outputSize] = 0;
