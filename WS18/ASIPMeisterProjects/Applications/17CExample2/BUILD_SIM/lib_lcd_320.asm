...
.data
	.align 2
	.type	_barcounter1667, @object
	.size	_barcounter1667, 4
_barcounter1667:
	.long	1
.text
	.align 2
...
;  Function 'g_makebar'; 56 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	...
	sw	32(r4),r14
	sw	36(r4),r15
	addi	r6,r0,%hi(_barcounter1667)
	lsoi	r6,r6,%lo(_barcounter1667)
	lw	r7,(r6)
	nop
	addi	r6,r0,#31
	elt	r6,r6,r7
