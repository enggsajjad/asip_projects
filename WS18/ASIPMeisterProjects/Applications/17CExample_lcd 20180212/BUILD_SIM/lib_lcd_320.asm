...
_checkbuffer:
;  Function 'checkbuffer'; 32 bytes of locals, 0 regs to save, 0 byte of out. args. size.
	sw	-4(r5),r3	; push LinkRegister(r3)
	sw	-8(r5),r4	; push FrameRegister(r4)
	addi	r4, r5,#-8	; FramePtr = StackPtr-8
...
_getbytes:
;  Function 'getbytes'; 24 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	sw	-4(r5),r3	; push LinkRegister(r3)
	sw	-8(r5),r4	; push FrameRegister(r4)
	addi	r4, r5,#-8	; FramePtr = StackPtr-8
...
.data
	.align 2
	.type	_barcounter1728, @object
	.size	_barcounter1728, 4
_barcounter1728:
	.long	1
.text
	.align 2
...
;  Function 'g_makebar'; 56 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	...
	sw	32(r4),r14
	sw	36(r4),r15
	addi	r6,r0,%hi(_barcounter1728)
	lsoi	r6,r6,%lo(_barcounter1728)
	lw	r7,(r6)
	nop
	addi	r6,r0,#31
	elt	r6,r6,r7
