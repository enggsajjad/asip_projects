...
_getack:
;  Function 'getack'; 16 bytes of locals, 0 regs to save, 0 byte of out. args. size.
	sw	-4(r5),r3	; push LinkRegister(r3)
	sw	-8(r5),r4	; push FrameRegister(r4)
	addi	r4, r5,#-8	; FramePtr = StackPtr-8
...
;  Function 'sendcommand'; 32 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	...
	add	r6,r7,r6
	sw	-32(r4),r6
	addi	r8,r0,%hi(.LC_lib_lcd_320_1)
	lsoi	r8,r8,%lo(.LC_lib_lcd_320_1)
	jpl	_u_print
	jp	.L_lib_lcd_320_28
.L_lib_lcd_320_29:
	lw	r6,-28(r4)
...
.L_lib_lcd_320_31:
	...
	addi	r6,r0,#0
	eneq	r6,r7,r6
	brnz	r6,.L_lib_lcd_320_32
	lw	r7,-12(r4)
	nop
	lw	r6,-32(r4)
	nop
	sw	(r7),r6
	addi	r8,r0,%hi(.LC_lib_lcd_320_2)
	lsoi	r8,r8,%lo(.LC_lib_lcd_320_2)
	jpl	_u_print
	addi	r8,r0,#152
	lsoi	r8,r8,#38528
	jpl	_wait
	addi	r8,r0,%hi(.LC_lib_lcd_320_3)
	lsoi	r8,r8,%lo(.LC_lib_lcd_320_3)
	jpl	_u_print
	addi	r6,r0,#0
	nop
	lw	r3,4(r4)	; pop LinkRegister(r3)
...
.data
	.align 2
	.type	_barcounter1686, @object
	.size	_barcounter1686, 4
_barcounter1686:
	.long	1
.text
	.align 2
...
;  Function 'g_makebar'; 56 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	...
	sw	32(r4),r14
	sw	36(r4),r15
	addi	r6,r0,%hi(_barcounter1686)
	lsoi	r6,r6,%lo(_barcounter1686)
	lw	r7,(r6)
	nop
	addi	r6,r0,#31
	elt	r6,r6,r7
	brnz	r6,.L_lib_lcd_320_42
	addi	r6,r0,%hi(_barcounter1686)
	lsoi	r6,r6,%lo(_barcounter1686)
	lw	r6,(r6)
	nop
...
;  Function 't_printHex'; 12 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	...
	nop
	jpl	_intToHexStr
	addi	r8,r0,%hi(.LC_lib_lcd_320_4)
	lsoi	r8,r8,%lo(.LC_lib_lcd_320_4)
	jpl	_t_print
	addi	r6,r4,#-10
	add	r8,r0,r6
	jpl	_t_print
