...
L_loop_2:
	...
	jp	L_loop_7
L_loop_8:
	addi	r8,r0,%hi(LC_loop_0)
	lsoi	r8,r8,%lo(LC_loop_0)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r7,r0,%hi(_input1)
	...
	add	r8,r0,r6
	jpl	_t_printInt
	addi	r8,r0,%hi(LC_loop_1)
	lsoi	r8,r8,%lo(LC_loop_1)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r7,r0,%hi(_input2)
	...
	add	r8,r0,r6
	jpl	_t_printInt
	addi	r8,r0,%hi(LC_loop_2)
	lsoi	r8,r8,%lo(LC_loop_2)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r7,r0,%hi(_resultAvg)
	...
	add	r8,r0,r6
	jpl	_t_printInt
	addi	r8,r0,%hi(LC_loop_3)
	lsoi	r8,r8,%lo(LC_loop_3)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r7,r0,%hi(_resultSwap)
	...
	add	r8,r0,r6
	jpl	_t_printInt
	addi	r8,r0,%hi(LC_loop_4)
	lsoi	r8,r8,%lo(LC_loop_4)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r7,r0,%hi(_resultMax)
	...
	add	r8,r0,r6
	jpl	_t_printInt
	addi	r8,r0,%hi(LC_loop_5)
	lsoi	r8,r8,%lo(LC_loop_5)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r7,r0,%hi(_resultMin)
	...
	add	r8,r0,r6
	jpl	_t_printInt
	addi	r8,r0,%hi(LC_loop_6)
	lsoi	r8,r8,%lo(LC_loop_6)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r7,r0,%hi(_resultRor)
	...
	add	r8,r0,r6
	jpl	_t_printInt
	addi	r8,r0,%hi(LC_loop_7)
	lsoi	r8,r8,%lo(LC_loop_7)
	jpl	_t_print
	lw	r6,-4(r4)
	nop
	addi	r6,r6,#1
