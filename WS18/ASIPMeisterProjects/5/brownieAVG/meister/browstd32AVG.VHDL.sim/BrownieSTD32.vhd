...
-- Generated by ASIP Meister 2.3 on 2018/12/05 17:16:09 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal ua_preg10_dout : std_logic_vector(4 downto 0);
  signal ua_preg08_dout : std_logic_vector(31 downto 0);
  signal const_32h00000020 : std_logic_vector(31 downto 0);
  signal concat_09 : std_logic_vector(31 downto 0);
  signal bitrange4to0_02 : std_logic_vector(4 downto 0);
  signal uf_sftvar1_data_out : std_logic_vector(31 downto 0);
  ...
  signal const_27h0000000 : std_logic_vector(26 downto 0);
  signal ua_preg07_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux36_dout : std_logic_vector(4 downto 0);
  ...
  signal uf_sftvar1_mode : std_logic_vector(1 downto 0);
  ...
  signal ua_mux09_sel : std_logic_vector(3 downto 0);
  signal ua_mux10_sel : std_logic;
  signal ua_mux11_sel : std_logic_vector(3 downto 0);
  ...
  signal ua_mux17_sel : std_logic_vector(3 downto 0);
  signal ua_mux18_sel : std_logic;
  signal ua_mux19_sel : std_logic_vector(3 downto 0);
  ...
  signal ua_mux28_sel : std_logic_vector(3 downto 0);
  ...
  signal unused_09 : std_logic_vector(4 downto 0);
  ...
  signal unused_13 : std_logic_vector(31 downto 0);
  signal unused_14 : std_logic;
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel0 => ua_mux36_dout, 
      w_sel1 => ua_preg10_dout, 
      data_in0 => ua_mux37_dout, 
  ...
  UF_FWU2 : fhm_fwu_w32
    port map (
      data0 => unused_08, 
      data1 => ua_altsel01_dout, 
      data2 => ua_preg08_dout, 
      num0 => unused_09, 
      num1 => ua_preg09_dout, 
      num2 => ua_preg10_dout, 
      fw1 => uf_fwu2_fw1, 
  ...
  UF_SFTvar1 : fhm_shifter_w32
    port map (
      data_in => ua_preg03_dout, 
      mode => uf_sftvar1_mode, 
      ctrl => bitrange4to0_02, 
      data_out => uf_sftvar1_data_out
    );
  ...
  UA_CTRL : rtg_controller
    port map (
      ...
      CTRLIN_BITPOS3_00_EXE => bitpos3_00, 
      ...
      CTRLOUT_SFTVAR1_MODE => uf_sftvar1_mode, 
  ...
  UA_MUX09 : rtg_mux15to1_w32
    port map (
      ...
      DIN13 => uf_alu1_result, 
      DIN14 => ua_preg00_dout, 
      DOUT => ua_mux09_dout
    );
  ...
  const_32h00000020 <= "00000000000000000000000000100000";
  const_27h0000000 <= "000000000000000000000000000";
  concat_09 <= const_27h0000000 & ua_preg07_dout;
  bitrange4to0_02 <= uf_alu_result(4 downto 0);
