...
#ifndef lint
static char rcsid[] = "$Header: /home/cvs/cvs_repos/dlxsim/dlx/dlxsim/tcl/tclBasic.c,v 1.1.1.2 2004/08/30 09:15:06 sascha Exp $ SPRITE (Berkeley)";
#endif
...
#   define NUM_ARGS 10
	...
	if ((result != TCL_OK) && (result != TCL_ERROR)) {
		...
		iPtr->result = iPtr->resultSpace;
		sprintf(iPtr->resultSpace, "ERROR: command returned bad code: %d\n",
			result);
	    }
	    result = TCL_ERROR;
	}
