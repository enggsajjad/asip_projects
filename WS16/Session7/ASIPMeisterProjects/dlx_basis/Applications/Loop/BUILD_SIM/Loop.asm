...
L_arrayloop_2:
	...
	lhi	%r3,$( _input2	/0x10000)
	nop
	nop
	nop
	ori	%r3,%r3,$( _input2	%0x10000)
	lhi	%r4,$0	
	nop
	nop
	nop
	...
	; Automatically 1 NOPs removed by reduceNOPs.sh
	ori	%r4,%r4,$4	
	lhi	%r5,$( _resultAvg	/0x10000)
	nop
	nop
	nop
	ori	%r5,%r5,$( _resultAvg	%0x10000)
	lw	%r2,0(%r2)	
	lw	%r3,0(%r3)	
	mult	%r4,%r1,%r4	
	lhi	%r6,$0	
	...
	; Automatically 1 NOPs removed by reduceNOPs.sh
	ori	%r8,%r8,$4	
	lhi	%r3,$( _input1	/0x10000)
	nop
	nop
	nop
	ori	%r3,%r3,$( _input1	%0x10000)
	mult	%r7,%r1,%r7	
	div	%r2,%r2,%r6	
	add	%r4,%r5,%r4	
	lhi	%r9,$( _input1	/0x10000)
	nop
	nop
	nop
	ori	%r9,%r9,$( _input1	%0x10000)
	mult	%r8,%r1,%r8	
	add	%r3,%r3,%r7	
	sw	0(%r4),%r2	
	nop	;;30,32
	...
	ori	%r7,%r7,$4	
	andi	%r3,%r3,$65535	
	lhi	%r6,$( _resultSwap	/0x10000)
	nop
	nop
	nop
	ori	%r6,%r6,$( _resultSwap	%0x10000)
	lhi	%r8,$0	
	nop
	nop
	nop
	; Automatically 1 NOPs removed by reduceNOPs.sh
	ori	%r8,%r8,$4	
	lhi	%r5,$( _input1	/0x10000)
	nop
	nop
	nop
	ori	%r5,%r5,$( _input1	%0x10000)
	or	%r2,%r2,%r3	
	mult	%r7,%r1,%r7	
	add	%r4,%r6,%r4	
	lhi	%r9,$( _input2	/0x10000)
	nop
	nop
	nop
	ori	%r9,%r9,$( _input2	%0x10000)
	mult	%r8,%r1,%r8	
	add	%r3,%r5,%r7	
	sw	0(%r4),%r2	
	nop	;;55,57
...
L_arrayloop_3:
	...
	nop
	ori	%r2,%r2,$( _input1	%0x10000)
	lhi	%r3,$( _resultMax	/0x10000)
	nop
	nop
	nop
	ori	%r3,%r3,$( _resultMax	%0x10000)
	lhi	%r4,$0	
	nop
	nop
	nop
...
L_arrayloop_6:
	...
	nop
	ori	%r2,%r2,$( _input1	%0x10000)
	lhi	%r3,$( _resultMin	/0x10000)
	nop
	nop
	nop
	ori	%r3,%r3,$( _resultMin	%0x10000)
	lhi	%r4,$0	
	nop
	nop
	nop
...
L_arrayloop_8:
	...
	nop	;;5,7
	nop	;;5,7
	lhi	%r6,$( _resultRor	/0x10000)
	nop
	nop
	nop
	ori	%r6,%r6,$( _resultRor	%0x10000)
	mult	%r4,%r1,%r4	
	mult	%r5,%r1,%r5	
	lhi	%r7,$0	
	nop
