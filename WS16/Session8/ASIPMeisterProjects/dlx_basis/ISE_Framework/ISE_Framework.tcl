# 
# Project automation script for ISE_Framework 
# 
# Created for ISE version 13.2
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source ISE_Framework.tcl), then you can
...
set myProject "ISE_Framework"
set myScript "ISE_Framework.tcl"
...
proc add_source_files {} {
   ...
   xfile add "AudioOut_TopLevel.vhd"
   xfile add "AudioOut_Types.vhd"
   xfile add "CPU.vhd"
   xfile add "Debouncer.vhd"
   xfile add "DigitalAnalogConverter.vhd"
   xfile add "MemoryMapper.vhd"
   xfile add "MemoryMapperTypes.vhd"
   xfile add "audio_out_fifo.ngc"
   xfile add "audio_out_fifo.vhd"
   xfile add "blockram.bmm"
   xfile add "bram_dm.ngc"
   xfile add "bram_dm.vhd"
   xfile add "brom_im.ngc"
   xfile add "brom_im.vhd"
   xfile add "clk_div.vhd"
   xfile add "dlxTypes.vhd"
   xfile add "dlx_toplevel.ucf"
   xfile add "dlx_toplevel.vhd"
   xfile add "fhm_alu_w32.vhd"
   xfile add "fhm_divider_w32.vhd"
   xfile add "fhm_dmau_w32.vhd"
   xfile add "fhm_extender_w16.vhd"
   xfile add "fhm_extender_w28.vhd"
   xfile add "fhm_imau_w32.vhd"
   xfile add "fhm_multiplier_w32.vhd"
   xfile add "fhm_pcu_w32.vhd"
   xfile add "fhm_register_w32.vhd"
   xfile add "fhm_registerfile_w32.vhd"
   xfile add "fhm_shifter_w32.vhd"
   xfile add "fifo_generator_v2_1.ngc"
   xfile add "fifo_generator_v2_1.vhd"
   xfile add "i2c_arbiter.vhd"
   xfile add "i2c_multiclock_latch.vhd"
   xfile add "i2c_toplevel.vhd"
   xfile add "interface_asipmeister_i2c.vhd"
   xfile add "ipcore_dir/DCM_100.xaw"
   xfile add "kcuart_rx.vhd"
   xfile add "kcuart_tx.vhd"
   xfile add "pca9564_interface_state.vhd"
   xfile add "rtg_controller.vhd"
   xfile add "rtg_mux14to1_w32.vhd"
   xfile add "rtg_mux2to1_w32.vhd"
   xfile add "rtg_mux2to1_w5.vhd"
   xfile add "rtg_mux3to1_w32.vhd"
   xfile add "rtg_mux3to1_w5.vhd"
   xfile add "rtg_mux4to1_w32.vhd"
   xfile add "rtg_proc_fsm.vhd"
   xfile add "rtg_register_w12.vhd"
   xfile add "rtg_register_w1_00.vhd"
   xfile add "rtg_register_w1_01.vhd"
   xfile add "rtg_register_w32.vhd"
   xfile add "rtg_register_w34.vhd"
   xfile add "rtg_register_w4.vhd"
   xfile add "rtg_register_w5.vhd"
   xfile add "rtg_register_w7.vhd"

   # Set the Top Module as well...
   project set top "Behavioral" "dlx_toplevel"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/asip04/LabASIP/Session8/ASIPMeisterProjects/dlx_basis_96/ISE_Framework/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "dlx_toplevel" -process "Generate IBIS Model"
