...
"OP-code"{"name"{"funct"},width{"5","0"}}
}
}}}},

Instruction{NO_VLIW{"add"{type{"R_R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
...
"Operand"{"name"{"rd"},width{"20","16"}},
"Operand"{"name"{"const"},width{"15","0"}}
},"sub"{type{"R_R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
...
},"avg"{type{"R_R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"OP-code"{"binary"{"00000010111"},width{"10","0"}}
},"clamp"{type{"R_4R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"100111"},width{"5","0"}}
},"predict"{type{"R_4R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"111001"},width{"5","0"}}
},"clamp_low"{type{"R_R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"OP-code"{"binary"{"00000110101"},width{"10","0"}}
},"clamp_high"{type{"R_R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"OP-code"{"binary"{"00000110110"},width{"10","0"}}
},"predict_add"{type{"R_4R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"110111"},width{"5","0"}}
},"predict_sub"{type{"R_4R"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"111000"},width{"5","0"}}
}}},

Operation{NO_VLIW{"add"{Mode{"user_mode"},Behavior{"rd = rs0 + rs1;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
...
,"sub"{Mode{"user_mode"},Behavior{"rd = rs0 - rs1;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
...
,"avg"{Mode{"user_mode"},Behavior{"rd = (rs0 + rs1) /2;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"clamp"{Mode{"user_mode"},Behavior{"rd = rs0;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"predict"{Mode{"user_mode"},Behavior{""},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"clamp_low"{Mode{"user_mode"},Behavior{"rd = rs0 + rs1;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"clamp_high"{Mode{"user_mode"},Behavior{"rd = rs0 + rs1;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"predict_add"{Mode{"user_mode"},Behavior{"rd = rs0 + rs1 + rs2;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"predict_sub"{Mode{"user_mode"},Behavior{"rd = rs0 + rs1 + rs2;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
}},
...
bit_width{"32"},
algorithm{"cla"}}}
,"MUX0"{class{"multiplexor"},classpath{"/basicfhmdb/computational/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
number_of_ports{"3"}}}
,"ADD0"{class{"adder"},classpath{"/basicfhmdb/computational/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
algorithm{"cla"}}}
,"MUX1"{class{"multiplexor"},classpath{"/basicfhmdb/computational/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
number_of_ports{"2"}}}
...
MOT{mnemonic{"add"{variable{"wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;
...
,"sub"{variable{"wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;
wire [31:0]  result;"},clk(1){"wire [31:0]  inst;
...
,"avg"{variable{"wire [31:0] result2;
wire [31:0] source0;
wire [31:0] source1;"},clk(1){"wire [31:0] inst;
...
clk(4){""},
clk(5){"null = GPR.write0(rd, result2);"}
}
,"clamp"{variable{"wire [31:0] index;
wire [31:0] lower;
wire [31:0] upper;
wire [31:0] result;"},clk(1){"wire [31:0] inst;
wire [31:0] current_pc;
...
cond1 = tmp_flag == \"010\";
cond2 = flag         == \"1001\";
cond_msb = cond1 | cond2;


/*compare with upper limit and generate a condition*/

flag1 = ALU1.cmp(index,upper);
tmp_flag1 = flag1[2:0];
cond3 = tmp_flag1 == \"000\";
cond4 = flag1         ==\"0011\";
cond_lsb = cond3 | cond4;

/* saturate to lower or upper limit*/
cond = <cond_msb,cond_lsb>;
result = MUX0.sel(index,lower,upper,cond);"},
clk(4){""},
clk(5){"null = GPR.write0(rd,result);"}
}
,"predict"{variable{"wire [31:0] result;
wire [31:0] predictor;
wire [31:0] difference;
wire [31:0] sign;"},clk(1){"wire [31:0] current_pc;
wire [31:0] inst;
...
<result1, flag1> = [cond]ALU0.sub(zeros, difference);
<result, cout> = ADD0.adc(predictor, difference, cin);"},
clk(4){""},
clk(5){"null = GPR.write0(rd,result);"}
}
,"clamp_low"{variable{"wire [31:0] index;
wire [31:0] lower;
wire [31:0] result;"},clk(1){"wire [31:0] inst;
wire [31:0] current_pc;
...
,"clamp_high"{variable{"wire [31:0] index;
wire [31:0] upper;
wire [31:0] result;"},clk(1){"wire [31:0] inst;
wire [31:0] current_pc;
...
,"predict_add"{variable{"wire [31:0] result;
wire [31:0] predictor;
wire [31:0] difference;
wire [31:0] sign;"},clk(1){"wire [31:0] inst;
wire [31:0] current_pc;
...
,"predict_sub"{variable{"wire [31:0] result;
wire [31:0] predictor;
wire [31:0] difference;
wire [31:0] sign;"},clk(1){"wire [31:0] inst;
wire [31:0] current_pc;
