...
(w_enb2 = '1' and w_sel2 = "11111") or
  ...
  data_in_tmp1 <= data_in0 when ((w_sel0 = "00001") and (w_enb_tmp1 =
  	'1')) else
  data_in1 when ((w_sel1 = "00001") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "00001") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp2 <= data_in0 when ((w_sel0 = "00010") and (w_enb_tmp2 =
  	'1')) else
  data_in1 when ((w_sel1 = "00010") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "00010") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp3 <= data_in0 when ((w_sel0 = "00011") and (w_enb_tmp3 =
  	'1')) else
  data_in1 when ((w_sel1 = "00011") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "00011") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp4 <= data_in0 when ((w_sel0 = "00100") and (w_enb_tmp4 =
  	'1')) else
  data_in1 when ((w_sel1 = "00100") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "00100") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp5 <= data_in0 when ((w_sel0 = "00101") and (w_enb_tmp5 =
  	'1')) else
  data_in1 when ((w_sel1 = "00101") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "00101") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp6 <= data_in0 when ((w_sel0 = "00110") and (w_enb_tmp6 =
  	'1')) else
  data_in1 when ((w_sel1 = "00110") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "00110") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp7 <= data_in0 when ((w_sel0 = "00111") and (w_enb_tmp7 =
  	'1')) else
  data_in1 when ((w_sel1 = "00111") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "00111") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp8 <= data_in0 when ((w_sel0 = "01000") and (w_enb_tmp8 =
  	'1')) else
  data_in1 when ((w_sel1 = "01000") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01000") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp9 <= data_in0 when ((w_sel0 = "01001") and (w_enb_tmp9 =
  	'1')) else
  data_in1 when ((w_sel1 = "01001") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01001") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp10 <= data_in0 when ((w_sel0 = "01010") and (w_enb_tmp10 =
  	'1')) else
  data_in1 when ((w_sel1 = "01010") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01010") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp11 <= data_in0 when ((w_sel0 = "01011") and (w_enb_tmp11 =
  	'1')) else
  data_in1 when ((w_sel1 = "01011") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01011") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp12 <= data_in0 when ((w_sel0 = "01100") and (w_enb_tmp12 =
  	'1')) else
  data_in1 when ((w_sel1 = "01100") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01100") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp13 <= data_in0 when ((w_sel0 = "01101") and (w_enb_tmp13 =
  	'1')) else
  data_in1 when ((w_sel1 = "01101") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01101") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp14 <= data_in0 when ((w_sel0 = "01110") and (w_enb_tmp14 =
  	'1')) else
  data_in1 when ((w_sel1 = "01110") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01110") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp15 <= data_in0 when ((w_sel0 = "01111") and (w_enb_tmp15 =
  	'1')) else
  data_in1 when ((w_sel1 = "01111") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "01111") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp16 <= data_in0 when ((w_sel0 = "10000") and (w_enb_tmp16 =
  	'1')) else
  data_in1 when ((w_sel1 = "10000") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10000") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp17 <= data_in0 when ((w_sel0 = "10001") and (w_enb_tmp17 =
  	'1')) else
  data_in1 when ((w_sel1 = "10001") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10001") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp18 <= data_in0 when ((w_sel0 = "10010") and (w_enb_tmp18 =
  	'1')) else
  data_in1 when ((w_sel1 = "10010") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10010") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp19 <= data_in0 when ((w_sel0 = "10011") and (w_enb_tmp19 =
  	'1')) else
  data_in1 when ((w_sel1 = "10011") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10011") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp20 <= data_in0 when ((w_sel0 = "10100") and (w_enb_tmp20 =
  	'1')) else
  data_in1 when ((w_sel1 = "10100") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10100") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp21 <= data_in0 when ((w_sel0 = "10101") and (w_enb_tmp21 =
  	'1')) else
  data_in1 when ((w_sel1 = "10101") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10101") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp22 <= data_in0 when ((w_sel0 = "10110") and (w_enb_tmp22 =
  	'1')) else
  data_in1 when ((w_sel1 = "10110") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10110") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp23 <= data_in0 when ((w_sel0 = "10111") and (w_enb_tmp23 =
  	'1')) else
  data_in1 when ((w_sel1 = "10111") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "10111") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp24 <= data_in0 when ((w_sel0 = "11000") and (w_enb_tmp24 =
  	'1')) else
  data_in1 when ((w_sel1 = "11000") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11000") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp25 <= data_in0 when ((w_sel0 = "11001") and (w_enb_tmp25 =
  	'1')) else
  data_in1 when ((w_sel1 = "11001") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11001") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp26 <= data_in0 when ((w_sel0 = "11010") and (w_enb_tmp26 =
  	'1')) else
  data_in1 when ((w_sel1 = "11010") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11010") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp27 <= data_in0 when ((w_sel0 = "11011") and (w_enb_tmp27 =
  	'1')) else
  data_in1 when ((w_sel1 = "11011") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11011") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp28 <= data_in0 when ((w_sel0 = "11100") and (w_enb_tmp28 =
  	'1')) else
  data_in1 when ((w_sel1 = "11100") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11100") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp29 <= data_in0 when ((w_sel0 = "11101") and (w_enb_tmp29 =
  	'1')) else
  data_in1 when ((w_sel1 = "11101") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11101") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp30 <= data_in0 when ((w_sel0 = "11110") and (w_enb_tmp30 =
  	'1')) else
  data_in1 when ((w_sel1 = "11110") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11110") and (w_enb_tmp2 = '1')) else
                  data_in3;
  data_in_tmp31 <= data_in0 when ((w_sel0 = "11111") and (w_enb_tmp31 =
  	'1')) else
  data_in1 when ((w_sel1 = "11111") and (w_enb_tmp1 = '1')) else
  data_in2 when ((w_sel2 = "11111") and (w_enb_tmp2 = '1')) else
                  data_in3;
