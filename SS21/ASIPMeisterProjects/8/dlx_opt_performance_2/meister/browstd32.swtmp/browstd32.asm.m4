...
static void insn_exec_dcdr (insn_info_t *insn, int32_t *operands);
static void insn_exec_four (insn_info_t *insn, int32_t *operands);
>>>>)
...
#define behavior_INIT__dcdr \
int32_t rd1 = operands[0];\
int32_t rd0 = operands[1];\
int32_t rs1 = operands[2];\
int32_t rs0 = operands[3];\

#define behavior_INIT__four \
int32_t rs4 = operands[0];\
int32_t rs3 = operands[1];\
