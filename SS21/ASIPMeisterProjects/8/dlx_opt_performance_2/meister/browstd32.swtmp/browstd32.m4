...
(define_insn "builtin_brownie32_dcdr"
[
  (unspec:VOID [
    (match_operand:SI 0 "brownie32_gr_regs_operand" "d") ;; rs0
    (match_operand:SI 1 "brownie32_gr_regs_operand" "d") ;; rs1
...
"dcdr %2 , %3 , %0 , %1 "
[(set_attr "length" "4")
 (set_attr "insn_mnemonic" "dcdr")]
)

(define_insn "builtin_brownie32_four"
[
  (unspec:VOID [
    (match_operand:SI 0 "brownie32_gr_regs_operand" "d") ;; rs1
    (match_operand:SI 1 "brownie32_gr_regs_operand" "d") ;; rs2
    (match_operand:SI 2 "brownie32_gr_regs_operand" "d") ;; rs3
    (match_operand:SI 3 "brownie32_gr_regs_operand" "d") ;; rs4
    ]  UNSPEC_BUILTIN_four)]
""
"four %0 , %1 , %2 , %3 "
[(set_attr "length" "4")
 (set_attr "insn_mnemonic" "four")]
)
...
tree ftype_dcdr = build_function_type_list (void_type_node, integer_type_node, integer_type_node, integer_type_node, integer_type_node, NULL_TREE);
tree ftype_four = build_function_type_list (void_type_node, integer_type_node, integer_type_node, integer_type_node, integer_type_node, NULL_TREE);

builtin_function ("__builtin_brownie32_pcm", ftype_pcm, CODE_FOR_builtin_brownie32_pcm, BUILT_IN_MD, NULL, NULL_TREE);
builtin_function ("__builtin_brownie32_dcdr", ftype_dcdr, CODE_FOR_builtin_brownie32_dcdr, BUILT_IN_MD, NULL, NULL_TREE);
builtin_function ("__builtin_brownie32_four", ftype_four, CODE_FOR_builtin_brownie32_four, BUILT_IN_MD, NULL, NULL_TREE);
>>>>)
...
(UNSPEC_BUILTIN_dcdr 10001)
(UNSPEC_BUILTIN_four 10002)
]
)
>>>>)

m4_define(<<<<__SCHEDULING__>>>>,<<<<(define_attr "insn_mnemonic"
  "pcm,dcdr,four,unknown"
...
(define_insn_reservation "dcdr" 1
  (eq_attr "insn_mnemonic"  "dcdr")
  "nothing"
)

(define_insn_reservation "four" 1
  (eq_attr "insn_mnemonic"  "four")
  "nothing"
)
