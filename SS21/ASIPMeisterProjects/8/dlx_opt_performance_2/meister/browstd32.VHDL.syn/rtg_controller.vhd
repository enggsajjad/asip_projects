...
-- Generated by ASIP Meister 2.3 on 2021/07/04 11:33:05 
----------------------------------------------------------------------
...
entity rtg_controller is
  port (
    ...
    CTRLOUT_DECODER_ENB : out std_logic;
    ...
    CTRLOUT_FWU4_FW1 : out std_logic;
    CTRLOUT_FWU5_FW1 : out std_logic;
    CTRLOUT_FWU6_FW1 : out std_logic;
    CTRLOUT_FWU7_FW1 : out std_logic;
    CTRLOUT_FWU2_FW2 : out std_logic;
    CTRLOUT_FWU3_FW2 : out std_logic;
    CTRLOUT_FWU4_FW2 : out std_logic;
    CTRLOUT_FWU5_FW2 : out std_logic;
    CTRLOUT_FWU6_FW2 : out std_logic;
    CTRLOUT_FWU7_FW2 : out std_logic;
    ...
    CTRLOUT_UA_MUX27_SEL : out std_logic_vector(1 downto 0);
...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w83;
  ...
  signal decoded_pcm : std_logic;
  signal decoded_dcdr : std_logic;
  signal decoded_four : std_logic;
  ...
  signal decout_DECODER_enb : std_logic;
  ...
  signal decout_FWU4_fw1 : std_logic;
  signal decout_FWU5_fw1 : std_logic;
  signal decout_FWU6_fw1 : std_logic;
  signal decout_FWU7_fw1 : std_logic;
  signal decout_FWU2_fw2 : std_logic;
  signal decout_FWU3_fw2 : std_logic;
  signal decout_FWU4_fw2 : std_logic;
  signal decout_FWU5_fw2 : std_logic;
  signal decout_FWU6_fw2 : std_logic;
  signal decout_FWU7_fw2 : std_logic;
  ...
  signal decout_UA_MUX27_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX28_SEL : std_logic_vector(3 downto 0);
  signal decout_UA_MUX29_SEL : std_logic;
  ...
  signal decout_UA_MUX33_SEL : std_logic;
  ...
  signal decout_ctrl_word_ID : std_logic_vector(121 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(82 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(82 downto 0);
  signal decout_ctrl_word_WB : std_logic_vector(24 downto 0);
  signal decout_ctrl_word_in_WB : std_logic_vector(24 downto 0);
  ...
  signal resctrl_DECODER_enb_inst : std_logic;
  ...
  signal resctrl_FWU4_fw1_inst : std_logic;
  signal resctrl_FWU5_fw1_inst : std_logic;
  signal resctrl_FWU6_fw1_inst : std_logic;
  signal resctrl_FWU7_fw1_inst : std_logic;
  signal resctrl_FWU2_fw2_inst : std_logic;
  signal resctrl_FWU3_fw2_inst : std_logic;
  signal resctrl_FWU4_fw2_inst : std_logic;
  signal resctrl_FWU5_fw2_inst : std_logic;
  signal resctrl_FWU6_fw2_inst : std_logic;
  signal resctrl_FWU7_fw2_inst : std_logic;
  ...
  signal resctrl_UA_MUX27_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX28_SEL_inst : std_logic_vector(3 downto 0);
  signal resctrl_UA_MUX29_SEL_inst : std_logic;
  ...
  signal resctrl_UA_MUX33_SEL_inst : std_logic;
...
begin
  ...
  decoded_pcm <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "110101" else
	'0';
  decoded_dcdr <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "111000" else
	'0';
  decoded_four <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "111001" else
	'0';
  ...
  decout_ctrl_word_ID(119 downto 119) <= 
	...
	"0";
  -- UA_MUX03.SEL:
  decout_ctrl_word_ID(118 downto 117) <= 
	...
	"00";
  -- UA_MUX04.SEL:
  decout_ctrl_word_ID(116 downto 115) <= 
  ...
  decout_ctrl_word_ID(114 downto 114) <= 
	...
	"0";
  -- UA_MUX09.SEL:
  decout_ctrl_word_ID(113 downto 111) <= 
	"101" when decoded_four = '1' else 
  ...
  decout_ctrl_word_ID(104 downto 103) <= 
	...
	"00";
  -- UA_MUX21.SEL:
  decout_ctrl_word_ID(102 downto 101) <= 
	"11" when decoded_four = '1' else 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LB = '1' or decoded_LH = '1' or decoded_LLSI = '1' or
	...
	"00";
  -- UA_MUX23.SEL:
  decout_ctrl_word_ID(100 downto 98) <= 
	"101" when decoded_four = '1' else 
	"100" when decoded_dcdr = '1' or decoded_pcm = '1' else 
  ...
  decout_ctrl_word_ID(97 downto 96) <= 
	"10" when decoded_four = '1' else 
	"01" when decoded_dcdr = '1' or decoded_pcm = '1' else 
	"00" when decoded_lbh = '1' else 
	"00";
  -- UA_MUX25.SEL:
  decout_ctrl_word_ID(95 downto 95) <= 
	"1" when decoded_four = '1' else 
	"0" when decoded_dcdr = '1' or decoded_pcm = '1' else 
	"0";
  -- UA_MUX26.SEL:
  decout_ctrl_word_ID(94 downto 94) <= 
	"1" when decoded_four = '1' else 
	"0" when decoded_dcdr = '1' or decoded_pcm = '1' else 
	"0";
  -- UA_MUX30.SEL:
  decout_ctrl_word_ID(93 downto 91) <= 
	"101" when decoded_four = '1' or decoded_lbh = '1' else 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  	or decoded_SH = '1' or decoded_SW = '1' else
	"001" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	...
  	decoded_LH = '1' or decoded_LLSI = '1' or decoded_LRSI = '1' or
  	decoded_LSOI = '1' or decoded_LW = '1' or decoded_ORI = '1' or
  	decoded_SUBI = '1' or decoded_XORI = '1' or decoded_dcdr = '1' or
  	decoded_pcm = '1' else
	"000" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	or decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  ...
  decout_ctrl_word_ID(90 downto 89) <= 
	"11" when decoded_four = '1' else 
	"10" when decoded_dcdr = '1' or decoded_pcm = '1' else 
	"01" when decoded_SB = '1' or decoded_SH = '1' or decoded_SW = '1'
  	else
	"00" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	or decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  ...
  decout_ctrl_word_ID(87 downto 87) <= 
	...
	"0";
  -- UA_MUX34.SEL:
  decout_ctrl_word_ID(86 downto 86) <= 
	"1" when decoded_four = '1' else 
	"0" when decoded_dcdr = '1' or decoded_pcm = '1' else 
	"0";
  -- UA_MUX35.SEL:
  decout_ctrl_word_ID(85 downto 85) <= 
	"1" when decoded_four = '1' else 
	"0" when decoded_dcdr = '1' or decoded_pcm = '1' else 
	"0";
  -- UA_MUX36.SEL:
  decout_ctrl_word_ID(84 downto 84) <= 
	"1" when decoded_four = '1' else 
	"0" when decoded_dcdr = '1' or decoded_pcm = '1' else 
	"0";
  -- UA_MUX37.SEL:
  decout_ctrl_word_ID(83 downto 83) <= 
	...
	"0";
  -- ALU.mode:
  decout_ctrl_word_ID(82 downto 78) <= 
  ...
  decout_ctrl_word_ID(75 downto 75) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_XOR = '1' or decoded_XORI = '1' or decoded_four = '1' else
	"0";
  -- FWU1.fw1:
  ...
  decout_ctrl_word_ID(65 downto 65) <= 
	"1" when decoded_dcdr = '1' or decoded_four = '1' or decoded_pcm = '1'
  	else
	"0";
  -- FWU2.fw1:
  ...
  decout_ctrl_word_ID(60 downto 60) <= 
	...
	"0";
  -- FWU7.fw1:
  decout_ctrl_word_ID(59 downto 59) <= 
	"1" when decoded_four = '1' else 
	"0";
  -- UA_MUX00.SEL:
  ...
  decout_ctrl_word_ID(56 downto 53) <= 
	"1100" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1011" when decoded_four = '1' else 
	...
	"0000";
  -- UA_MUX08.SEL:
  decout_ctrl_word_ID(52 downto 49) <= 
	"1100" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1011" when decoded_four = '1' else 
	"1010" when decoded_EXHW = '1' else 
	"1001" when decoded_EXBW = '1' else 
  ...
  decout_ctrl_word_ID(48 downto 48) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_SUBI = '1' or decoded_XOR = '1' or decoded_XORI = '1' or
  	decoded_four = '1' else
  ...
  decout_ctrl_word_ID(47 downto 44) <= 
	...
	"0000";
  -- UA_MUX16.SEL:
  decout_ctrl_word_ID(43 downto 40) <= 
	"1100" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1011" when decoded_four = '1' else 
	"1010" when decoded_EXHW = '1' else 
	"1001" when decoded_EXBW = '1' else 
  ...
  decout_ctrl_word_ID(39 downto 39) <= 
	...
	"0";
  -- UA_MUX28.SEL:
  decout_ctrl_word_ID(38 downto 35) <= 
	"1100" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1011" when decoded_dcdr = '1' or decoded_four = '1' or decoded_pcm =
  	'1' else
	"1010" when decoded_EXHW = '1' else 
	"1001" when decoded_EXBW = '1' else 
	"1000" when decoded_ENEQ = '1' else 
	...
	"0000" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND =
  	...
  	decoded_XORI = '1' else
	"0000";
  decout_ctrl_word_ID(34) <= 
	'1' when decoded_TRAP = '1' else 
	'0';
  decout_ctrl_word_ID(33) <= 
	'1' when decoded_BRZ = '1' else 
	'0';
  decout_ctrl_word_ID(32) <= 
	'1' when decoded_BRNZ = '1' else 
	'0';
  decout_ctrl_word_ID(31) <= 
	'1' when decoded_JP = '1' or decoded_JPL = '1' or decoded_JPR = '1' or
  	decoded_JPRL = '1' or decoded_RETI = '1' else
	'0';
  ...
  decout_ctrl_word_ID(25) <= 
	...
	'0';
  -- GPR.w_enb0:
  decout_ctrl_word_ID(24 downto 24) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	or decoded_ANDI = '1' or decoded_ARS = '1' or decoded_ARSI = '1' or
  	decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	...
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' or decoded_dcdr = '1' or
  	decoded_four = '1' or decoded_lbh = '1' or decoded_pcm = '1' else
	"0";
  -- FWU0.fw2:
  decout_ctrl_word_ID(23 downto 23) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	or decoded_ANDI = '1' or decoded_ARS = '1' or decoded_ARSI = '1' or
  	decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  ...
  decout_ctrl_word_ID(22 downto 22) <= 
	...
	"0";
  -- DMAU.rw_out:
  decout_ctrl_word_ID(21 downto 21) <= 
	"1" when decoded_SB = '1' or decoded_SH = '1' or decoded_SW = '1' else
	"0" when decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1' or
  	decoded_lbh = '1' else
	"0";
  -- DMAU.mode_out:
  decout_ctrl_word_ID(20 downto 19) <= 
  ...
  decout_ctrl_word_ID(17 downto 17) <= 
	"1" when decoded_dcdr = '1' or decoded_four = '1' or decoded_lbh = '1'
  	or decoded_pcm = '1' else
	"0";
  -- GPR.w_enb2:
  ...
  decout_ctrl_word_ID(4 downto 4) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_OR = '1' or decoded_ORI = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' or decoded_XOR = '1' or decoded_XORI = '1' or
  	decoded_dcdr = '1' or decoded_four = '1' or decoded_lbh = '1' or
  	decoded_pcm = '1' else
	"0" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"0";
  -- UA_MUX27.SEL:
  decout_ctrl_word_ID(3 downto 2) <= 
	"10" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_ORI = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' or decoded_dcdr = '1' or
  	decoded_four = '1' or decoded_pcm = '1' else
  ...
  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(82 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(24 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(121);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(120);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(119);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(118 downto 117);
  decout_UA_MUX04_SEL <= decout_ctrl_word_ID(116 downto 115);
  decout_UA_MUX05_SEL <= decout_ctrl_word_ID(114);
  decout_UA_MUX09_SEL <= decout_ctrl_word_ID(113 downto 111);
  decout_UA_MUX11_SEL <= decout_ctrl_word_ID(110 downto 109);
  decout_UA_MUX13_SEL <= decout_ctrl_word_ID(108 downto 107);
  decout_UA_MUX17_SEL <= decout_ctrl_word_ID(106 downto 105);
  decout_UA_MUX19_SEL <= decout_ctrl_word_ID(104 downto 103);
  decout_UA_MUX21_SEL <= decout_ctrl_word_ID(102 downto 101);
  decout_UA_MUX23_SEL <= decout_ctrl_word_ID(100 downto 98);
  decout_UA_MUX24_SEL <= decout_ctrl_word_ID(97 downto 96);
  decout_UA_MUX25_SEL <= decout_ctrl_word_ID(95);
  decout_UA_MUX26_SEL <= decout_ctrl_word_ID(94);
  decout_UA_MUX30_SEL <= decout_ctrl_word_ID(93 downto 91);
  decout_UA_MUX31_SEL <= decout_ctrl_word_ID(90 downto 89);
  decout_UA_MUX32_SEL <= decout_ctrl_word_ID(88);
  decout_UA_MUX33_SEL <= decout_ctrl_word_ID(87);
  decout_UA_MUX34_SEL <= decout_ctrl_word_ID(86);
  decout_UA_MUX35_SEL <= decout_ctrl_word_ID(85);
  decout_UA_MUX36_SEL <= decout_ctrl_word_ID(84);
  decout_UA_MUX37_SEL <= decout_ctrl_word_ID(83);
  decout_ALU_mode <= decout_ctrl_word_EXE(82 downto 78);
  decout_ALU_cin <= decout_ctrl_word_EXE(77);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(76);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(75);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(74);
  decout_MUL_mode <= decout_ctrl_word_EXE(73);
  decout_DIV_mode <= decout_ctrl_word_EXE(72);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(71 downto 70);
  decout_PC_load <= decout_ctrl_word_EXE(69);
  decout_GPR_status_enb <= decout_ctrl_word_EXE(68);
  decout_EXT8TO32_mode <= decout_ctrl_word_EXE(67);
  decout_EXT16TO32A_mode <= decout_ctrl_word_EXE(66);
  decout_DECODER_enb <= decout_ctrl_word_EXE(65);
  decout_FWU2_fw1 <= decout_ctrl_word_EXE(64);
  decout_FWU3_fw1 <= decout_ctrl_word_EXE(63);
  decout_FWU4_fw1 <= decout_ctrl_word_EXE(62);
  decout_FWU5_fw1 <= decout_ctrl_word_EXE(61);
  decout_FWU6_fw1 <= decout_ctrl_word_EXE(60);
  decout_FWU7_fw1 <= decout_ctrl_word_EXE(59);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(58);
  decout_UA_MUX02_SEL <= decout_ctrl_word_EXE(57);
  decout_UA_MUX06_SEL <= decout_ctrl_word_EXE(56 downto 53);
  decout_UA_MUX08_SEL <= decout_ctrl_word_EXE(52 downto 49);
  decout_UA_MUX10_SEL <= decout_ctrl_word_EXE(48);
  decout_UA_MUX14_SEL <= decout_ctrl_word_EXE(47 downto 44);
  decout_UA_MUX16_SEL <= decout_ctrl_word_EXE(43 downto 40);
  decout_UA_MUX18_SEL <= decout_ctrl_word_EXE(39);
  decout_UA_MUX28_SEL <= decout_ctrl_word_EXE(38 downto 35);
  cause_TRAPINT_inst_at_EXE_00 <= decout_ctrl_word_EXE(34);
  branch_inst_at_EXE_0 <= decout_ctrl_word_EXE(33);
  branch_inst_at_EXE_1 <= decout_ctrl_word_EXE(32);
  branch_inst_at_EXE_2 <= decout_ctrl_word_EXE(31);
  multcyc_MUL_start_c0_inst_EXE <= decout_ctrl_word_EXE(30);
  multcyc_DIV_start_c0_inst_EXE <= decout_ctrl_word_EXE(29);
  asgn_PC_load_inst_v0c0_EXE <= decout_ctrl_word_EXE(28);
  asgn_PC_load_inst_v0c1_EXE <= decout_ctrl_word_EXE(27);
  asgn_UA_MUX00_SEL_inst_v0c0_EXE <= decout_ctrl_word_EXE(26);
  asgn_UA_MUX00_SEL_inst_v0c1_EXE <= decout_ctrl_word_EXE(25);
  decout_GPR_w_enb0 <= decout_ctrl_word_WB(24);
  decout_FWU0_fw2 <= decout_ctrl_word_WB(23);
  decout_FWU1_fw2 <= decout_ctrl_word_WB(22);
  decout_DMAU_rw_out <= decout_ctrl_word_WB(21);
  decout_DMAU_mode_out <= decout_ctrl_word_WB(20 downto 19);
  decout_DMAU_ext_out <= decout_ctrl_word_WB(18);
  decout_GPR_w_enb1 <= decout_ctrl_word_WB(17);
  decout_GPR_w_enb2 <= decout_ctrl_word_WB(16);
  decout_GPR_w_enb3 <= decout_ctrl_word_WB(15);
  decout_FWU2_fw2 <= decout_ctrl_word_WB(14);
  decout_FWU3_fw2 <= decout_ctrl_word_WB(13);
  decout_FWU4_fw2 <= decout_ctrl_word_WB(12);
  decout_FWU5_fw2 <= decout_ctrl_word_WB(11);
  decout_FWU6_fw2 <= decout_ctrl_word_WB(10);
  decout_FWU7_fw2 <= decout_ctrl_word_WB(9);
  ...
  decout_UA_MUX27_SEL <= decout_ctrl_word_WB(3 downto 2);
  decout_UA_MUX29_SEL <= decout_ctrl_word_WB(1);
  ...
  resctrl_GPR_w_enb1_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_GPR_w_enb1;
  resctrl_DECODER_enb_inst <= decout_DECODER_enb;
  resctrl_GPR_w_enb2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_GPR_w_enb2;
  resctrl_GPR_w_enb3_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_GPR_w_enb3;
  ...
  resctrl_FWU3_fw1_inst <= 
	'0' when advance_stage_EXE = '0' else 
	decout_FWU3_fw1;
  resctrl_FWU4_fw1_inst <= 
	'0' when advance_stage_EXE = '0' else 
	decout_FWU4_fw1;
  resctrl_FWU5_fw1_inst <= 
	'0' when advance_stage_EXE = '0' else 
	decout_FWU5_fw1;
  resctrl_FWU6_fw1_inst <= 
	'0' when advance_stage_EXE = '0' else 
	decout_FWU6_fw1;
  resctrl_FWU7_fw1_inst <= 
	'0' when advance_stage_EXE = '0' else 
	decout_FWU7_fw1;
  ...
  resctrl_FWU3_fw2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_FWU3_fw2;
  resctrl_FWU4_fw2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_FWU4_fw2;
  resctrl_FWU5_fw2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_FWU5_fw2;
  resctrl_FWU6_fw2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_FWU6_fw2;
  resctrl_FWU7_fw2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_FWU7_fw2;
  ...
  CTRLOUT_GPR_W_ENB1 <= 
	...
	'0';
  CTRLOUT_DECODER_ENB <= 
	resctrl_DECODER_enb_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_GPR_W_ENB2 <= 
	resctrl_GPR_w_enb2_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_GPR_W_ENB3 <= 
	resctrl_GPR_w_enb3_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU2_FW1 <= 
  ...
  CTRLOUT_FWU3_FW1 <= 
	...
	'0';
  CTRLOUT_FWU4_FW1 <= 
	resctrl_FWU4_fw1_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU5_FW1 <= 
	resctrl_FWU5_fw1_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU6_FW1 <= 
	resctrl_FWU6_fw1_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU7_FW1 <= 
	resctrl_FWU7_fw1_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU2_FW2 <= 
  ...
  CTRLOUT_FWU3_FW2 <= 
	...
	'0';
  CTRLOUT_FWU4_FW2 <= 
	resctrl_FWU4_fw2_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU5_FW2 <= 
	resctrl_FWU5_fw2_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU6_FW2 <= 
	resctrl_FWU6_fw2_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU7_FW2 <= 
	resctrl_FWU7_fw2_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_MUL_START <= 
  ...
  CTRLOUT_UA_PREG06_ENB <= pipereg_enb_WB;
