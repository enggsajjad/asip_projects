...
-- Generated by ASIP Meister 2.3 on 2021/07/04 11:33:04 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  end component fhm_adpcmdecode_w32;
  ...
  end component rtg_mux13to1_w32;
  ...
  signal uf_decoder_out_1 : std_logic_vector(31 downto 0);
  signal ua_preg06_dout : std_logic_vector(31 downto 0);
  signal ua_preg07_dout : std_logic_vector(31 downto 0);
  signal uf_fwu2_data_out : std_logic_vector(31 downto 0);
  signal uf_fwu3_data_out : std_logic_vector(31 downto 0);
  signal ua_preg12_dout : std_logic_vector(4 downto 0);
  signal uf_decoder_out_2 : std_logic_vector(31 downto 0);
  signal ua_preg08_dout : std_logic_vector(4 downto 0);
  signal uf_decoder_index_out : std_logic_vector(31 downto 0);
  ...
  signal ua_preg11_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux33_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux42_dout : std_logic_vector(31 downto 0);
  ...
  signal uf_decoder_clock : std_logic;
  signal uf_decoder_reset : std_logic;
  signal uf_decoder_enb : std_logic;
  ...
  signal uf_fwu5_fw1 : std_logic;
  signal uf_fwu5_fw2 : std_logic;
  signal uf_fwu6_fw1 : std_logic;
  signal uf_fwu6_fw2 : std_logic;
  signal uf_fwu7_fw1 : std_logic;
  signal uf_fwu7_fw2 : std_logic;
  ...
  signal ua_mux27_sel : std_logic_vector(1 downto 0);
  signal ua_mux28_sel : std_logic_vector(3 downto 0);
  signal ua_mux29_sel : std_logic;
  ...
  signal unused_08 : std_logic_vector(4 downto 0);
  ...
  signal unused_18 : std_logic_vector(31 downto 0);
  signal unused_19 : std_logic;
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel0 => ua_mux41_dout, 
      w_sel1 => ua_preg29_dout, 
      w_sel2 => ua_preg31_dout, 
      w_sel3 => ua_preg33_dout, 
      data_in0 => ua_mux42_dout, 
      data_in1 => ua_mux29_dout, 
      data_in2 => ua_preg07_dout, 
      data_in3 => ua_preg06_dout, 
      r_sel0 => ua_mux30_dout, 
      r_sel1 => ua_mux31_dout, 
      r_sel2 => ua_mux32_dout, 
      r_sel3 => ua_mux33_dout, 
  ...
  UF_DECODER : fhm_adpcmdecode_w32
    port map (
      clock => uf_decoder_clock, 
      reset => uf_decoder_reset, 
      enb => uf_decoder_enb, 
      delta_1 => ua_preg35_dout, 
      delta_2 => ua_preg36_dout, 
      output_in => ua_preg37_dout, 
      index_in => ua_preg38_dout, 
      out_1 => uf_decoder_out_1, 
      out_2 => uf_decoder_out_2, 
      index_out => uf_decoder_index_out
    );

  UF_FWU2 : fhm_fwu_w32
    port map (
      data0 => uf_gpr_data_out2, 
      data1 => uf_decoder_out_2, 
      data2 => ua_preg06_dout, 
      num0 => bitrange15to11_00, 
      num1 => ua_preg12_dout, 
      num2 => ua_preg13_dout, 
      fw1 => uf_fwu2_fw1, 
      fw2 => uf_fwu2_fw2, 
      data_out => uf_fwu2_data_out
    );
  ...
  UF_FWU3 : fhm_fwu_w32
    port map (
      ...
      data1 => uf_decoder_out_2, 
      data2 => ua_preg06_dout, 
      num0 => bitrange10to6_00, 
      num1 => ua_preg12_dout, 
      num2 => ua_preg13_dout, 
      fw1 => uf_fwu3_fw1, 
      fw2 => uf_fwu3_fw2, 
      data_out => uf_fwu3_data_out
    );

  UF_FWU4 : fhm_fwu_w32
    port map (
      data0 => unused_07, 
      data1 => uf_decoder_index_out, 
      data2 => ua_preg07_dout, 
      num0 => unused_08, 
      num1 => ua_preg08_dout, 
      num2 => ua_preg09_dout, 
      fw1 => uf_fwu4_fw1, 
  ...
  UA_CTRL : rtg_controller
    port map (
      ...
      CTRLOUT_DECODER_ENB => uf_decoder_enb, 
      CTRLOUT_GPR_W_ENB2 => uf_gpr_w_enb2, 
      CTRLOUT_GPR_W_ENB3 => uf_gpr_w_enb3, 
      CTRLOUT_FWU2_FW1 => uf_fwu2_fw1, 
      CTRLOUT_FWU3_FW1 => uf_fwu3_fw1, 
      CTRLOUT_FWU4_FW1 => uf_fwu4_fw1, 
      CTRLOUT_FWU5_FW1 => uf_fwu5_fw1, 
      CTRLOUT_FWU6_FW1 => uf_fwu6_fw1, 
      CTRLOUT_FWU7_FW1 => uf_fwu7_fw1, 
      CTRLOUT_FWU2_FW2 => uf_fwu2_fw2, 
      CTRLOUT_FWU3_FW2 => uf_fwu3_fw2, 
      CTRLOUT_FWU4_FW2 => uf_fwu4_fw2, 
      CTRLOUT_FWU5_FW2 => uf_fwu5_fw2, 
      CTRLOUT_FWU6_FW2 => uf_fwu6_fw2, 
      CTRLOUT_FWU7_FW2 => uf_fwu7_fw2, 
  ...
  UA_MUX06 : rtg_mux13to1_w32
    port map (
      ...
      DIN11 => uf_decoder_out_1, 
      DIN12 => ua_preg00_dout, 
      DOUT => ua_mux06_dout
    );
  ...
  UA_MUX36 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux36_sel, 
      DIN0 => uf_gpr_data_out3, 
      DIN1 => uf_fwu3_data_out, 
      DOUT => ua_mux36_dout
    );
