...
entity fhm_extender_w26 is
  port (data_in  : in std_logic_vector(25 downto 0);
        mode     : in std_logic;
        data_out : out std_logic_vector(31 downto 0));
end fhm_extender_w26;

architecture synthesis of fhm_extender_w26 is
begin
  data_out(25 downto 0) <= data_in;
    sign_ext : for i in 31 downto 26 generate
     data_out(i) <= data_in(25) when mode = '1' else '0';
