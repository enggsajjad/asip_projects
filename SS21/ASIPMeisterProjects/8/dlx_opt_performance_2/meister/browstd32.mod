...
// Generated by ASIP Meister 2.3 on 2021/07/04 11:34:21 
Design{
Version{"2.3"},
...
"Operand"{"name"{"rs1"},width{"25","21"}},
"Operand"{"name"{"rs2"},width{"20","16"}},
"Operand"{"name"{"rs3"},width{"15","11"}},
"Operand"{"name"{"rs4"},width{"10","6"}},
"OP-code"{"name"{"opc"},width{"5","0"}}
}
,"RR2"{
"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd0"},width{"15","11"}},
"Operand"{"name"{"rd1"},width{"10","6"}},
"OP-code"{"name"{"op"},width{"5","0"}}
}
,"RR1"{
"OP-code"{"binary"{"0000000000000000"},width{"31","16"}},
"Operand"{"name"{"rs"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"name"{"op"},width{"5","0"}}
}
,"LS2"{
"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rd0"},width{"20","16"}},
"Operand"{"name"{"rd1"},width{"15","11"}},
...
"OP-code"{"binary"{"00010"},width{"10","6"}},
"OP-code"{"binary"{"000000"},width{"5","0"}}
},"lbh"{type{"LS2"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rd0"},width{"20","16"}},
"Operand"{"name"{"rd1"},width{"15","11"}},
"OP-code"{"binary"{"00000"},width{"10","6"}},
"OP-code"{"binary"{"110000"},width{"5","0"}}
},"pcm"{type{"RR2"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd0"},width{"15","11"}},
"Operand"{"name"{"rd1"},width{"10","6"}},
"OP-code"{"binary"{"110101"},width{"5","0"}}
},"dcdr"{type{"RR2"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd0"},width{"15","11"}},
"Operand"{"name"{"rd1"},width{"10","6"}},
"OP-code"{"binary"{"111000"},width{"5","0"}}
},"four"{type{"RRTWO"},"Reserved"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs1"},width{"25","21"}},
"Operand"{"name"{"rs2"},width{"20","16"}},
"Operand"{"name"{"rs3"},width{"15","11"}},
"Operand"{"name"{"rs4"},width{"10","6"}},
...
bit_width{"16"},
bit_width_out{"32"}}}
,"DECODER"{class{"adpcmdecode"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"}}}
...
addr_width{"5"},
stage_number{"2"}}}
,"FWU5"{class{"fwu"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
addr_width{"5"},
stage_number{"2"}}}
,"FWU6"{class{"fwu"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
addr_width{"5"},
stage_number{"2"}}}
,"FWU7"{class{"fwu"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
addr_width{"5"},
...
<result, addr_err> = DMAU.ld_8(addr);
result0_t1 = result[7:4];
result1_t1 = result[3:0];
zeroes = \\"0000000000000000000000000000\\";
result0 = <zeroes, result0_t1>;
result1 = <zeroes, result1_t1>;



null = GPR.write0(rd0, result0);
null = GPR.write1(rd1, result1);"}
}
,"pcm"{variable{"wire [31:0] delta_1;
wire [31:0] delta_2;
wire [31:0] old_idx;
wire [31:0] old_out;
wire [31:0] out_1;
...
fetch_status_data           = GPR.status_read();
null                        = DUMMY_STREG.write(fetch_status_data);"},
clk(2){"delta_1 = GPR.read0(rd0);
delta_2 = GPR.read1(rd1);
old_idx = GPR.read2(rs0);
old_out = GPR.read3(rs1);"},
clk(3){"<out_1, out_2, index_out> = DECODER.pcmdec(delta_1, delta_2, old_idx, old_out);

//out_1 = \"00000000000000000000110000100001\";
//out_2 = \"00000000000000000000110000100010\";
//index_out = \"00000000000000000000110000100011\";"},
clk(4){"null = GPR.write0(rd0, out_1);
null = GPR.write1(rd1, out_2);
null = GPR.write2(rs0, index_out);
null = GPR.write3(rs1, out_2);"}
}
,"dcdr"{variable{"wire [31:0] d1;
wire [31:0] d2;
wire [31:0] oldx;
wire [31:0] oldo;
wire [31:0] o1;
...
fetch_status_data           = GPR.status_read();
null                        = DUMMY_STREG.write(fetch_status_data);"},
clk(2){"d1 = GPR.read0(rd0);
d2 = GPR.read1(rd1);
oldx = GPR.read2(rs0);
oldo = GPR.read3(rs1);"},
clk(3){"wire [31:0] idx;

<o1, o2, idx> = DECODER.pcmdec(d1, d2, oldx, oldo);
...
//out_2 = \"00000000000000000000110000100010\";
//index_out = \"00000000000000000000110000100011\";"},
clk(4){"null = GPR.write0(rd0, o1);
null = GPR.write1(rd1, o2);
null = GPR.write2(rs0, idxo);
null = GPR.write3(rs1, o2);"}
}
,"four"{variable{"wire [31:0] d1;
wire [31:0] d2;
wire [31:0] oldx;
wire [31:0] oldo;
wire [31:0] o1;
...
wire [31:0]  gpr_double_read_stmp4;

// prefetch GPR data to stmp1/stmp2
gpr_double_read_stmp1   = GPR.read0(rs1);
gpr_double_read_stmp2   = GPR.read1(rs2);
gpr_double_read_stmp3   = GPR.read2(rs3);
gpr_double_read_stmp4   = GPR.read3(rs4);

// get source value
// from GPR or forwarded value selectively
d1  = FWU0.forward(rs1, gpr_double_read_stmp1);
d2  = FWU1.forward(rs2, gpr_double_read_stmp2);
oldx  = FWU2.forward(rs3, gpr_double_read_stmp3);
oldo  = FWU3.forward(rs4, gpr_double_read_stmp4);"},
clk(3){"wire [31:0] idx;

<o1, o2, idx> = DECODER.pcmdec(d1, d2, oldx, oldo);

idxo = idx;
// foward o1 to as GPR[rs1] from stage EXE
null = FWU0.forward1(rs1, o1);
null = FWU1.forward1(rs1, o1);
// foward o2 to as GPR[rs2] from stage EXE
null = FWU2.forward1(rs2, o2);
null = FWU3.forward1(rs2, o2);
// foward idxo to as GPR[rs3] from stage EXE
null = FWU4.forward1(rs3, idxo);
null = FWU5.forward1(rs3, idxo);
// foward o2 to as GPR[rs4] from stage EXE
null = FWU6.forward1(rs4, o2);
null = FWU7.forward1(rs4, o2);"},
clk(4){"null = GPR.write0(rs1, o1);
null = GPR.write1(rs2, o2);
null = GPR.write2(rs3, idxo);
null = GPR.write3(rs4, o2);
// foward o1 to as GPR[rs1] from stage WB
null = FWU0.forward2(rs1, o1);
null = FWU1.forward2(rs1, o1);
// foward o2 to as GPR[rs2] from stage WB
null = FWU2.forward2(rs2, o2);
null = FWU3.forward2(rs2, o2);
// foward idxo to as GPR[rs3] from stage WB
null = FWU4.forward2(rs3, idxo);
null = FWU5.forward2(rs3, idxo);
// foward o2 to as GPR[rs4] from stage WB
null = FWU6.forward2(rs4, o2);
null = FWU7.forward2(rs4, o2);"}
}
}}
