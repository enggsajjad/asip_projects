...
// Generated by ASIP Meister 2.3 on 2021/07/02 11:47:57 
Design{
Version{"2.3"},
...
},"lhh"{type{"LS2"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rd0"},width{"20","16"}},
"Operand"{"name"{"rd1"},width{"15","11"}},
"OP-code"{"binary"{"00000"},width{"10","6"}},
"OP-code"{"binary"{"110110"},width{"5","0"}}
},"ble"{type{"B2"},"Operand"{"name"{"const"},width{"31","16"}},
"Operand"{"name"{"rs0"},width{"15","11"}},
"Operand"{"name"{"rs1"},width{"10","6"}},
...
bit_width{"16"},
bit_width_out{"32"}}}
,"DECODER2"{class{"adpcmdecode2"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"}}}
...
clk(3){"<out_1, out_2, index_out> = DECODER2.pcmdec(delta_1, delta_2, old_idx, old_out);"},
clk(4){"wire [15:0] zeroes;
wire [15:0] last_sample_15;
wire [31:0] last_sample;

null = GPR.write0(rd0, out_1);
null = GPR.write1(rd1, out_2);
null = GPR.write2(rs0, index_out);

zeroes = \\"0000000000000000\\";
last_sample_15 = out_2[15:0];
last_sample = <zeroes, last_sample_15>;
null = GPR.write3(rs1, last_sample);"}
}
,"lhh"{variable{"wire [31:0] addr;
wire [31:0] result0;
wire [31:0] result1;
wire [31:0] new_addr;
/* these variables can be used in following stages of all instructions */"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
...
<new_addr,cout> = ADD0.adc(addr, one, cin);"},
clk(4){"wire addr_err;
wire [31:0] result;
wire [7:0] result1_t1;
wire [7:0] result0_t1;
...
<result, addr_err> = DMAU.ld_16(addr);
result0_t1 = result[15:8];
result1_t1 = result[7:0];
zeroes = \\"000000000000000000000000\\";
result0 = <zeroes, result0_t1>;
result1 = <zeroes, result1_t1>;
...
null = GPR.write0(rd0, result0);
null = GPR.write1(rd1, result1);
null = GPR.write2(rs0, new_addr);"}
}
,"ble"{variable{"wire [31:0] offset;
/* these variables can be used in following stages of all instructions */
/* these variables can be used in following stages of all instructions */
wire [31:0] pcread_result;
wire [31:0]  source1;
...
// prefetch GPR data to stmp1/stmp2
gpr_double_read_stmp1   = GPR.read0(rs0);
gpr_double_read_stmp2   = GPR.read1(rs1);

// get source value
// from GPR or forwarded value selectively
source1  = FWU0.forward(rs0, gpr_double_read_stmp1);
source2  = FWU1.forward(rs1, gpr_double_read_stmp2);
offset = EXT16TO32.sign(const);
pcread_result = PC.read();"},
clk(3){"wire [3:0]  flag;
wire [2:0]   tmp_flag;
wire           cond1;
...
cin = '0';
//<target,cout>   = ADD0.adc(fetch_current_pc, offset, cin);
<target,cout>   = ADD0.adc(pcread_result, offset, cin);
