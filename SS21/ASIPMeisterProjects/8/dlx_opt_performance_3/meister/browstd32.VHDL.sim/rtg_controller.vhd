...
entity rtg_controller is
  port (
    ...
    CTRLIN_BITOR_03_EXE : in std_logic;
    ...
    CTRLOUT_DECODER2_ENB : out std_logic;
    ...
    CTRLOUT_UA_MUX26_SEL : out std_logic_vector(3 downto 0);
...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w78;
  ...
  signal decoded_lhh : std_logic;
  signal decoded_ble : std_logic;
  ...
  signal decout_DECODER2_enb : std_logic;
  ...
  signal decout_UA_MUX26_SEL : std_logic_vector(3 downto 0);
  ...
  signal decout_ctrl_word_ID : std_logic_vector(108 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(77 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(77 downto 0);
  ...
  signal resctrl_DECODER2_enb_inst : std_logic;
  ...
  signal resctrl_UA_MUX26_SEL_inst : std_logic_vector(3 downto 0);
...
begin
  ...
  decoded_lhh <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(10 downto 6) = "00000" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "110110" else
	'0';
  decoded_ble <= 
	'1' when DATAIN_IR_DATA_OUT(5 downto 0) = "110111" else 
	'0';
  ...
  decout_ctrl_word_ID(108 downto 108) <= 
	...
	"1" when decoded_ADDI = '1' or decoded_BRNZ = '1' or decoded_BRZ = '1'
  	...
  	decoded_SW = '1' or decoded_ble = '1' else
	"0";
  -- EXT26TO32.mode:
  ...
  decout_ctrl_word_ID(105 downto 104) <= 
	...
	"00" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_XORI = '1' or decoded_ble = '1' else
	"00";
  -- UA_MUX04.SEL:
  decout_ctrl_word_ID(103 downto 102) <= 
	...
	"00" when decoded_ADD = '1' or decoded_AND = '1' or decoded_EEQ = '1'
  	...
  	decoded_SUB = '1' or decoded_XOR = '1' or decoded_ble = '1' else
	"00";
  -- UA_MUX05.SEL:
  ...
  decout_ctrl_word_ID(100 downto 98) <= 
	...
	"001" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	...
  	decoded_LSOI = '1' or decoded_LW = '1' or decoded_ORI = '1' or
  	decoded_SUBI = '1' or decoded_XORI = '1' or decoded_ble = '1' else
  ...
  decout_ctrl_word_ID(87 downto 85) <= 
	"100" when decoded_pcm = '1' else 
	"011" when decoded_lbh = '1' or decoded_lhh = '1' else 
  ...
  decout_ctrl_word_ID(84 downto 84) <= 
	"1" when decoded_pcm = '1' else 
	"0" when decoded_lbh = '1' or decoded_lhh = '1' else 
	"0";
  -- UA_MUX29.SEL:
  decout_ctrl_word_ID(83 downto 81) <= 
	"101" when decoded_lbh = '1' or decoded_lhh = '1' else 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  	or decoded_SH = '1' or decoded_SW = '1' else
	"001" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	...
  	decoded_LH = '1' or decoded_LLSI = '1' or decoded_LRSI = '1' or
  	decoded_LSOI = '1' or decoded_LW = '1' or decoded_ORI = '1' or
  	decoded_SUBI = '1' or decoded_XORI = '1' or decoded_ble = '1' or
  	decoded_pcm = '1' else
	"000" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	or decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  ...
  decout_ctrl_word_ID(80 downto 79) <= 
	"10" when decoded_ble = '1' or decoded_pcm = '1' else 
	"01" when decoded_SB = '1' or decoded_SH = '1' or decoded_SW = '1'
  	else
	"00" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	or decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  ...
  decout_ctrl_word_ID(78 downto 78) <= 
	"1" when decoded_ble = '1' else 
	"0" when decoded_lhh = '1' else 
	"0";
  -- ALU.mode:
  decout_ctrl_word_ID(77 downto 73) <= 
	...
	"01010" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ELTU =
  	'1' or decoded_ENEQ = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_ble = '1' else
  ...
  decout_ctrl_word_ID(72 downto 72) <= 
	"1" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ELTU = '1'
  	or decoded_ENEQ = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_ble = '1' else
  ...
  decout_ctrl_word_ID(57 downto 57) <= 
	"1" when decoded_lbh = '1' or decoded_lhh = '1' else 
  ...
  decout_ctrl_word_ID(34 downto 34) <= 
	"1" when decoded_lhh = '1' else 
	"0" when decoded_pcm = '1' else 
	"0";
  -- UA_MUX32.SEL:
  ...
  decout_ctrl_word_ID(19 downto 19) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' or decoded_lbh = '1' or
  	decoded_lhh = '1' or decoded_pcm = '1' else
	"0";
  -- FWU0.fw2:
  ...
  decout_ctrl_word_ID(16 downto 16) <= 
	...
	"0" when decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1' or
  	decoded_lbh = '1' or decoded_lhh = '1' else
	"0";
  -- DMAU.mode_out:
  decout_ctrl_word_ID(15 downto 14) <= 
	"11" when decoded_LW = '1' or decoded_SW = '1' else 
	"01" when decoded_LH = '1' or decoded_SH = '1' or decoded_lhh = '1'
  	else
  ...
  decout_ctrl_word_ID(13 downto 13) <= 
	"1" when decoded_LB = '1' or decoded_LH = '1' or decoded_lbh = '1' or
  	decoded_lhh = '1' else
	"0";
  -- GPR.w_enb1:
  decout_ctrl_word_ID(12 downto 12) <= 
	"1" when decoded_lbh = '1' or decoded_lhh = '1' or decoded_pcm = '1'
  	else
	"0";
  -- GPR.w_enb2:
  decout_ctrl_word_ID(11 downto 11) <= 
	"1" when decoded_lhh = '1' or decoded_pcm = '1' else 
	"0";
  -- GPR.w_enb3:
  ...
  decout_ctrl_word_ID(5 downto 5) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_lbh = '1' or decoded_lhh = '1' or decoded_pcm = '1' else
	"0" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"0";
  -- UA_MUX25.SEL:
  decout_ctrl_word_ID(4 downto 3) <= 
	"11" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	or decoded_ANDI = '1' or decoded_ARS = '1' or decoded_ARSI = '1' or
  	decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_EXBW = '1' or decoded_EXHW = '1' or decoded_JPL = '1' or
  	...
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' or decoded_pcm = '1' else
	"10" when decoded_lhh = '1' else 
	"01" when decoded_lbh = '1' else 
	"00" when decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1'
  	else
	"00";
  -- UA_MUX27.SEL:
  decout_ctrl_word_ID(2 downto 1) <= 
	"10" when decoded_pcm = '1' else 
	"01" when decoded_lhh = '1' else 
  ...
  decout_ctrl_word_ID(0) <= 
	'1' when decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1' or
  	...
  	= '1' or decoded_lhh = '1' else
	'0';

  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(77 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(19 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(108);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(107);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(106);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(105 downto 104);
  decout_UA_MUX04_SEL <= decout_ctrl_word_ID(103 downto 102);
  decout_UA_MUX05_SEL <= decout_ctrl_word_ID(101);
  decout_UA_MUX09_SEL <= decout_ctrl_word_ID(100 downto 98);
  decout_UA_MUX11_SEL <= decout_ctrl_word_ID(97 downto 96);
  decout_UA_MUX13_SEL <= decout_ctrl_word_ID(95 downto 94);
  decout_UA_MUX17_SEL <= decout_ctrl_word_ID(93 downto 92);
  decout_UA_MUX19_SEL <= decout_ctrl_word_ID(91 downto 90);
  decout_UA_MUX21_SEL <= decout_ctrl_word_ID(89 downto 88);
  decout_UA_MUX23_SEL <= decout_ctrl_word_ID(87 downto 85);
  decout_UA_MUX24_SEL <= decout_ctrl_word_ID(84);
  decout_UA_MUX29_SEL <= decout_ctrl_word_ID(83 downto 81);
  decout_UA_MUX30_SEL <= decout_ctrl_word_ID(80 downto 79);
  decout_UA_MUX31_SEL <= decout_ctrl_word_ID(78);
  decout_ALU_mode <= decout_ctrl_word_EXE(77 downto 73);
  decout_ALU_cin <= decout_ctrl_word_EXE(72);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(71);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(70);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(69);
  decout_MUL_mode <= decout_ctrl_word_EXE(68);
  decout_DIV_mode <= decout_ctrl_word_EXE(67);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(66 downto 65);
  decout_PC_load <= decout_ctrl_word_EXE(64);
  decout_GPR_status_enb <= decout_ctrl_word_EXE(63);
  decout_EXT8TO32_mode <= decout_ctrl_word_EXE(62);
  decout_EXT16TO32A_mode <= decout_ctrl_word_EXE(61);
  decout_DECODER2_enb <= decout_ctrl_word_EXE(60);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(59 downto 58);
  ...
  decout_UA_MUX26_SEL <= decout_ctrl_word_EXE(38 downto 35);
  decout_UA_MUX28_SEL <= decout_ctrl_word_EXE(34);
  decout_UA_MUX32_SEL <= decout_ctrl_word_EXE(33);
  cause_TRAPINT_inst_at_EXE_00 <= decout_ctrl_word_EXE(32);
  branch_inst_at_EXE_0 <= decout_ctrl_word_EXE(31);
  branch_inst_at_EXE_1 <= decout_ctrl_word_EXE(30);
  branch_inst_at_EXE_2 <= decout_ctrl_word_EXE(29);
  branch_inst_at_EXE_3 <= decout_ctrl_word_EXE(28);
  multcyc_MUL_start_c0_inst_EXE <= decout_ctrl_word_EXE(27);
  multcyc_DIV_start_c0_inst_EXE <= decout_ctrl_word_EXE(26);
  asgn_PC_load_inst_v0c0_EXE <= decout_ctrl_word_EXE(25);
  asgn_PC_load_inst_v0c1_EXE <= decout_ctrl_word_EXE(24);
  asgn_PC_load_inst_v0c2_EXE <= decout_ctrl_word_EXE(23);
  asgn_UA_MUX00_SEL_inst_v0c0_EXE <= decout_ctrl_word_EXE(22);
  asgn_UA_MUX00_SEL_inst_v0c1_EXE <= decout_ctrl_word_EXE(21);
  asgn_UA_MUX00_SEL_inst_v1c0_EXE <= decout_ctrl_word_EXE(20);
  decout_GPR_w_enb0 <= decout_ctrl_word_WB(19);
  decout_FWU0_fw2 <= decout_ctrl_word_WB(18);
  decout_FWU1_fw2 <= decout_ctrl_word_WB(17);
  decout_DMAU_rw_out <= decout_ctrl_word_WB(16);
  decout_DMAU_mode_out <= decout_ctrl_word_WB(15 downto 14);
  decout_DMAU_ext_out <= decout_ctrl_word_WB(13);
  decout_GPR_w_enb1 <= decout_ctrl_word_WB(12);
  decout_GPR_w_enb2 <= decout_ctrl_word_WB(11);
  decout_GPR_w_enb3 <= decout_ctrl_word_WB(10);
  decout_UA_MUX07_SEL <= decout_ctrl_word_WB(9);
  decout_UA_MUX12_SEL <= decout_ctrl_word_WB(8);
  decout_UA_MUX15_SEL <= decout_ctrl_word_WB(7);
  decout_UA_MUX20_SEL <= decout_ctrl_word_WB(6);
  decout_UA_MUX22_SEL <= decout_ctrl_word_WB(5);
  decout_UA_MUX25_SEL <= decout_ctrl_word_WB(4 downto 3);
  decout_UA_MUX27_SEL <= decout_ctrl_word_WB(2 downto 1);
  ...
  resctrl_GPR_w_enb1_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_GPR_w_enb1;
  resctrl_DECODER2_enb_inst <= decout_DECODER2_enb;
  ...
  resctrl_UA_MUX00_SEL_inst <= 
	...
	"01" when valid_stage_EXE = '1' and asgn_UA_MUX00_SEL_inst_v1c0_EXE =
  	'1' and CTRLIN_BITOR_03_EXE = '1' else
	decout_UA_MUX00_SEL;
  ...
  CTRLOUT_GPR_W_ENB1 <= 
	...
	'0';
  CTRLOUT_DECODER2_ENB <= 
	resctrl_DECODER2_enb_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_GPR_W_ENB2 <= 
