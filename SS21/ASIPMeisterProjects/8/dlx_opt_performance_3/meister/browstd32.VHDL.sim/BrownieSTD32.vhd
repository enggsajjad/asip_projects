...
-- Generated by ASIP Meister 2.3 on 2021/06/29 06:22:17 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  component fhm_adpcmdecode2_w32
  port (
    clock : in std_logic;
    reset : in std_logic;
    enb : in std_logic;
  ...
  end component fhm_adpcmdecode2_w32;
  ...
  end component rtg_mux12to1_w32;
  ...
  signal bitrange15to0_02 : std_logic_vector(15 downto 0);
  ...
  signal uf_decoder2_out_2 : std_logic_vector(31 downto 0);
  ...
  signal uf_decoder2_clock : std_logic;
  signal uf_decoder2_reset : std_logic;
  signal uf_decoder2_enb : std_logic;
  ...
  signal ua_mux26_sel : std_logic_vector(3 downto 0);
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel1 => ua_preg30_dout, 
      w_sel2 => ua_preg12_dout, 
      w_sel3 => ua_preg14_dout, 
      data_in0 => ua_mux37_dout, 
      data_in1 => ua_mux27_dout, 
      data_in2 => ua_preg32_dout, 
      data_in3 => concat_08, 
      r_sel0 => ua_mux29_dout, 
      r_sel1 => ua_mux30_dout, 
      r_sel2 => bitrange25to21_00, 
      r_sel3 => bitrange20to16_00, 
  ...
  UF_DECODER2 : fhm_adpcmdecode2_w32
    port map (
      clock => uf_decoder2_clock, 
      reset => uf_decoder2_reset, 
      enb => uf_decoder2_enb, 
      in_1 => ua_preg06_dout, 
      in_2 => ua_preg07_dout, 
      output_in => ua_preg09_dout, 
      index_in => ua_preg08_dout, 
      out_1 => uf_decoder2_out_1, 
      out_2 => uf_decoder2_out_2, 
      index_out => uf_decoder2_index_out
    );
  ...
  UA_CTRL : rtg_controller
    port map (
      ...
      CTRLOUT_DECODER2_ENB => uf_decoder2_enb, 
  ...
  UA_MUX28 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux28_sel, 
      DIN0 => uf_decoder2_index_out, 
      DIN1 => uf_add0_result, 
      DOUT => ua_mux28_dout
    );

  UA_MUX29 : rtg_mux6to1_w5
    port map (
      SEL => ua_mux29_sel, 
      DIN0 => bitrange31to27_00, 
      DIN1 => bitrange15to11_00, 
  ...
  cmpeq_02 <= 
	'1' when ua_preg02_dout = "00000000000000000000000000000000" else 
	'0';
  cmpneq_00 <= 
	'1' when ua_preg02_dout /= "00000000000000000000000000000000" else 
	'0';
  ...
  bitor_01 <= ua_preg05_dout or const_32h00004300;
  bitrange7to0_00 <= ua_preg02_dout(7 downto 0);
  bitrange15to0_01 <= ua_preg02_dout(15 downto 0);
  ...
  bitrange15to0_02 <= ua_preg10_dout(15 downto 0);
  concat_08 <= const_16h0000 & bitrange15to0_02;
  const_32h00000002 <= "00000000000000000000000000000010";
  bitrange7to0_01 <= uf_dmau_data_in(7 downto 0);
  bitrange15to8_00 <= uf_dmau_data_in(15 downto 8);
  const_24h000000 <= "000000000000000000000000";
  concat_09 <= const_24h000000 & bitrange15to8_00;
  concat_10 <= const_24h000000 & bitrange7to0_01;
