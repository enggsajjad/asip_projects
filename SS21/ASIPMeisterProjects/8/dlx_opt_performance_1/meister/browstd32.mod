...
// Generated by ASIP Meister 2.3 on 2021/07/02 01:36:45 
Design{
Version{"2.3"},
...
},"lstep"{type{"RR1"},"OP-code"{"binary"{"0000000000000000"},width{"31","16"}},
"Operand"{"name"{"rs"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"110001"},width{"5","0"}}
},"step"{type{"RR2"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd0"},width{"15","11"}},
"Operand"{"name"{"rd1"},width{"10","6"}},
"OP-code"{"binary"{"110010"},width{"5","0"}}
},"addidx"{type{"RR"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rd"},width{"21","17"}},
"OP-code"{"binary"{"100"},width{"16","14"}},
"OP-code"{"binary"{"00000001"},width{"13","6"}},
"OP-code"{"binary"{"000001"},width{"5","0"}}
},"clmp"{type{"RR2"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd0"},width{"15","11"}},
"Operand"{"name"{"rd1"},width{"10","6"}},
"OP-code"{"binary"{"110011"},width{"5","0"}}
},"pcmdec"{type{"RR2"},"OP-code"{"binary"{"000000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd0"},width{"15","11"}},
"Operand"{"name"{"rd1"},width{"10","6"}},
"OP-code"{"binary"{"110100"},width{"5","0"}}
},"MMAX"{type{"RR2M"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rdMin"},width{"21","17"}},
"Operand"{"name"{"rdMax"},width{"16","12"}},
"OP-code"{"binary"{"000000"},width{"11","6"}},
"OP-code"{"binary"{"010010"},width{"5","0"}}
},"MMAXS"{type{"RR2M"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rdMin"},width{"21","17"}},
"Operand"{"name"{"rdMax"},width{"16","12"}},
"OP-code"{"binary"{"000000"},width{"11","6"}},
...
bit_width{"16"},
bit_width_out{"32"}}}
,"STEP"{class{"stepsize"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"4"}}}
,"IDX"{class{"index"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"4"}}}
,"CLMP"{class{"clamp"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"4"}}}
,"PCM"{class{"adpcm"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"4"}}}
...
addr_width{"5"},
stage_number{"2"}}}
,"MMX"{class{"minmax"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"}}}
},
...
,"lstep"{variable{"wire [31:0] source0;
wire [31:0] result;
/* these variables can be used in following stages of all instructions */"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
wire [31:0]  fetch_inst;                                    // opecode
wire         fetch_addrerr;                                 // address err. from IM
...
fetch_status_data           = GPR.status_read();
null                        = DUMMY_STREG.write(fetch_status_data);"},
clk(2){"source0 = GPR.read0(rs);"},
clk(3){"wire [6:0] data_in;
wire [15:0] data_out;
wire [15:0] zeroes;

data_in = source0[6:0];
zeroes = \\"0000000000000000\\";
data_out = STEP.stepsize(data_in);
result = <zeroes, data_out>;"},
clk(4){"null = GPR.write0(rd, result);        // write result[arg2] to GPR[arg1]"}
}
,"step"{variable{"wire [31:0] step_idx;
wire [31:0] idx_idx;
wire [31:0] old_idx;
wire [31:0] step;
wire [31:0] idx;
...
fetch_status_data           = GPR.status_read();
null                        = DUMMY_STREG.write(fetch_status_data);"},
clk(2){"wire [6:0] step_in;
wire [15:0] step_out;
wire [15:0] zeroes16;

step_idx = GPR.read0(rs0);
idx_idx   = GPR.read1(rs1);
old_idx   = GPR.read2(rd1);

step_in = \\"0000111\\";
zeroes16 = \\"0000000000000000\\";
step_out = STEP.stepsize(step_in);
step = <zeroes16, step_out>;"},
clk(3){"wire [3:0] idx_in;

idx_in = idx_idx[3:0];
idx = IDX.addidx(idx_in, old_idx);"},
clk(4){"null = GPR.write0(rd0, step);
null = GPR.write1(rd1, idx);"}
}
,"addidx"{variable{"wire [31:0] old_idx;
wire [31:0] idx_idx;
wire [31:0] result;
/* these variables can be used in following stages of all instructions */"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
wire [31:0]  fetch_inst;                                    // opecode
...
fetch_status_data           = GPR.status_read();
null                        = DUMMY_STREG.write(fetch_status_data);"},
clk(2){"old_idx = GPR.read0(rs1);
idx_idx = GPR.read1(rs2);"},
clk(3){"wire [3:0] data_in;

data_in = idx_idx[3:0];
result = IDX.addidx(data_in, old_idx);"},
clk(4){"null = GPR.write0(rd, result);        // write result[arg2] to GPR[arg1]"}
}
,"clmp"{variable{"wire [31:0] cmpval;
wire [31:0] lval;
wire [31:0] gval;
wire [31:0] result;
/* these variables can be used in following stages of all instructions */"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
...
fetch_status_data           = GPR.status_read();
null                        = DUMMY_STREG.write(fetch_status_data);"},
clk(2){"cmpval = GPR.read0(rd1);
lval = GPR.read1(rs0);
gval = GPR.read2(rs1);"},
clk(3){"result = CLMP.clamp(cmpval, gval, lval);"},
clk(4){"null = GPR.write0(rd0, result);        // write result[arg2] to GPR[arg1]"}
}
,"pcmdec"{variable{"wire [31:0] step;
wire [31:0] delta;
wire [31:0] valpred;
wire [31:0] result;
/* these variables can be used in following stages of all instructions */"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
...
fetch_status_data           = GPR.status_read();
null                        = DUMMY_STREG.write(fetch_status_data);"},
clk(2){"step = GPR.read0(rd1);
delta = GPR.read1(rs0);
valpred = GPR.read2(rs1);"},
clk(3){"result = PCM.pcmdec(step, delta, valpred);"},
clk(4){"null = GPR.write0(rd0, result);        // write result[arg2] to GPR[arg1]"}
}
,"MMAX"{variable{"wire [31:0] min;
wire [31:0] max;
/* these variables can be used in following stages of all instructions */
wire [31:0]  source1;
wire [31:0]  source2;"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
...
source1  = FWU0.forward(rs1, gpr_double_read_stmp1);
source2  = FWU1.forward(rs2, gpr_double_read_stmp2);"},
clk(3){"<min, max> = MMX.minmax(source1, source2);
...
,"MMAXS"{variable{"//wire [31:0] cmp_result;
wire [31:0] min;
wire [31:0] max;
/* these variables can be used in following stages of all instructions */
wire [31:0]  source1;
