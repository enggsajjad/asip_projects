...
{ 
  ...
  4,
  { 
    { "op_code0", 0, 6, 49, "49", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    ...
    { "rs", 11, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "op_code3", 16, 16, 0, "0", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
  },
},
/*addidx*/
{ 
  "addidx", "addidx %rd , %rs1 , %rs2 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 1, "1", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 8, 1, "1", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code2", 14, 3, 4, "4", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
...
/*clmp*/
{ 
  "clmp", "clmp %rd0 , %rd1 , %rs0 , %rs1 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 51, "51", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
...
/*pcmdec*/
{ 
  "pcmdec", "pcmdec %rd0 , %rd1 , %rs0 , %rs1 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 52, "52", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rd1", 6, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rd0", 11, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs1", 16, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs0", 21, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
...
/*MMAXS*/
{ 
  "MMAXS", "MMAXS %rdMin , %rdMax , %rs1 , %rs2 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 19, "19", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 6, 0, "0", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rdMax", 12, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rdMin", 17, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs2", 22, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
...
static void insn_exec_MMAX (insn_info_t *insn, int32_t *operands);
static void insn_exec_lstep (insn_info_t *insn, int32_t *operands);
static void insn_exec_addidx (insn_info_t *insn, int32_t *operands);
static void insn_exec_clmp (insn_info_t *insn, int32_t *operands);
static void insn_exec_pcmdec (insn_info_t *insn, int32_t *operands);
static void insn_exec_MMAXS (insn_info_t *insn, int32_t *operands);
>>>>)
