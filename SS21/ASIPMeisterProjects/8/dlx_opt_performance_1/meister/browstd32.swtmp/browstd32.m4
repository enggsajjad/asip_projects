...
m4_define(<<<<__RTL_TEMPLATES__>>>>,<<<<(define_insn "builtin_brownie32_MMAX"
[
  (unspec:VOID [
...
(define_insn "builtin_brownie32_clmp"
[
  (unspec:VOID [
...
m4_define(<<<<__INIT_BUILTINS__>>>>,<<<<tree ftype_MMAX = build_function_type_list (void_type_node, integer_type_node, integer_type_node, integer_type_node, integer_type_node, NULL_TREE);
...
(define_insn_reservation "lstep" 1
