...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w19;
  ...
  signal decoded_lbh : std_logic;
  signal decoded_lstep : std_logic;
  signal decoded_step : std_logic;
  signal decoded_addidx : std_logic;
  signal decoded_clmp : std_logic;
  signal decoded_pcmdec : std_logic;
  signal decoded_MMAX : std_logic;
  signal decoded_MMAXS : std_logic;
  signal strchzd_STEP_enb_EXE : std_logic;
  signal strchzd_STEP_enb_ID : std_logic;
  signal strchzd_UA_MUX33_SEL_EXE : std_logic;
  signal strchzd_UA_MUX33_SEL_ID : std_logic;
  signal sh_req_STEP_enb_ID : std_logic;
  signal sh_req_UA_MUX33_SEL_ID : std_logic;
  signal strchzd_stall_ID : std_logic;
  signal resconf_solved_ID : std_logic;
  signal prev_strchzd_stall_ID : std_logic;
  ...
  signal strchzd_STEP_enb_c_inst_EXE : std_logic;
  signal strchzd_STEP_enb_c_inst_ID : std_logic;
  signal decout_IDX_enb_new : std_logic;
  signal decout_CLMP_enb : std_logic;
  signal decout_PCM_enb_new : std_logic;
  signal decout_MMX_enb : std_logic;
  signal decout_FWU2_fw1 : std_logic;
  signal decout_FWU3_fw1 : std_logic;
  signal decout_FWU2_fw2 : std_logic;
  signal decout_FWU3_fw2 : std_logic;
  ...
  signal decout_UA_MUX04_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX05_SEL : std_logic;
  signal decout_UA_MUX06_SEL : std_logic_vector(3 downto 0);
  signal decout_UA_MUX07_SEL : std_logic;
  signal decout_UA_MUX08_SEL : std_logic_vector(3 downto 0);
  ...
  signal decout_UA_MUX13_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX14_SEL : std_logic_vector(3 downto 0);
  signal decout_UA_MUX15_SEL : std_logic;
  signal decout_UA_MUX16_SEL : std_logic_vector(3 downto 0);
  signal decout_UA_MUX17_SEL : std_logic;
  signal decout_UA_MUX18_SEL : std_logic;
  signal decout_UA_MUX19_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX20_SEL : std_logic;
  signal decout_UA_MUX21_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX22_SEL : std_logic;
  signal decout_UA_MUX23_SEL : std_logic_vector(2 downto 0);
  signal decout_UA_MUX24_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX25_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX26_SEL : std_logic_vector(4 downto 0);
  signal decout_UA_MUX27_SEL : std_logic;
  ...
  signal decout_UA_MUX32_SEL : std_logic;
  signal strchzd_UA_MUX33_SEL_c_inst_EXE : std_logic;
  signal strchzd_UA_MUX33_SEL_c_inst_ID : std_logic;
  signal decout_UA_MUX34_SEL : std_logic;
  signal decout_UA_MUX35_SEL : std_logic;
  signal decout_UA_MUX36_SEL : std_logic;
  signal decout_UA_MUX37_SEL : std_logic;
  signal decout_UA_MUX38_SEL : std_logic;
  signal decout_ctrl_word_ID : std_logic_vector(123 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(86 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(86 downto 0);
  signal decout_ctrl_word_WB : std_logic_vector(18 downto 0);
  signal decout_ctrl_word_in_WB : std_logic_vector(18 downto 0);
  ...
  signal resctrl_IDX_enb_new_inst : std_logic;
  signal resctrl_CLMP_enb_inst : std_logic;
  signal resctrl_PCM_enb_new_inst : std_logic;
  signal resctrl_MMX_enb_inst : std_logic;
  signal resctrl_FWU2_fw1_inst : std_logic;
  signal resctrl_FWU3_fw1_inst : std_logic;
  signal resctrl_FWU2_fw2_inst : std_logic;
  signal resctrl_FWU3_fw2_inst : std_logic;
  ...
  signal resctrl_UA_MUX04_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX05_SEL_inst : std_logic;
  signal resctrl_UA_MUX06_SEL_inst : std_logic_vector(3 downto 0);
  signal resctrl_UA_MUX07_SEL_inst : std_logic;
  signal resctrl_UA_MUX08_SEL_inst : std_logic_vector(3 downto 0);
  ...
  signal resctrl_UA_MUX13_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX14_SEL_inst : std_logic_vector(3 downto 0);
  signal resctrl_UA_MUX15_SEL_inst : std_logic;
  signal resctrl_UA_MUX16_SEL_inst : std_logic_vector(3 downto 0);
  signal resctrl_UA_MUX17_SEL_inst : std_logic;
  signal resctrl_UA_MUX18_SEL_inst : std_logic;
  signal resctrl_UA_MUX19_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX20_SEL_inst : std_logic;
  signal resctrl_UA_MUX21_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX22_SEL_inst : std_logic;
  signal resctrl_UA_MUX23_SEL_inst : std_logic_vector(2 downto 0);
  signal resctrl_UA_MUX24_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX25_SEL_inst : std_logic_vector(1 downto 0);
  signal resctrl_UA_MUX26_SEL_inst : std_logic_vector(4 downto 0);
  signal resctrl_UA_MUX27_SEL_inst : std_logic;
  ...
  signal resctrl_UA_MUX32_SEL_inst : std_logic;
  signal resctrl_UA_MUX34_SEL_inst : std_logic;
  signal resctrl_UA_MUX35_SEL_inst : std_logic;
  signal resctrl_UA_MUX36_SEL_inst : std_logic;
  signal resctrl_UA_MUX37_SEL_inst : std_logic;
  signal resctrl_UA_MUX38_SEL_inst : std_logic;
  signal resctrl_sh_STEP_enb_inst_EXE : std_logic;
  signal resctrl_sh_STEP_enb_inst_ID : std_logic;
  signal resctrl_sh_STEP_enb_inst : std_logic;
  signal resctrl_sh_UA_MUX33_SEL_inst_EXE : std_logic;
  signal resctrl_sh_UA_MUX33_SEL_inst_ID : std_logic;
  signal resctrl_sh_UA_MUX33_SEL_inst : std_logic;
...
begin
  ...
  UA_RESCONF_SOLVED_ID : rtg_register_w1
    port map (
      RST => RST, 
      CLK => CLK, 
      ENB => const_bit1, 
      DIN => strchzd_stall_ID, 
      DOUT => prev_strchzd_stall_ID
    );
  ...
  decoded_EXHW <= 
	...
	'0';
  decoded_lbh <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(10 downto 6) = "00000" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "110000" else
	'0';
  decoded_lstep <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 16) = "0000000000000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "110001" else
	'0';
  decoded_step <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "110010" else
	'0';
  decoded_addidx <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "100" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "00000001" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "000001" else
	'0';
  decoded_clmp <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "110011" else
	'0';
  decoded_pcmdec <= 
	'1' when DATAIN_IR_DATA_OUT(31 downto 26) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "110100" else
	'0';
  decoded_MMAX <= 
	'1' when DATAIN_IR_DATA_OUT(11 downto 6) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "010010" else
	'0';
  decoded_MMAXS <= 
	'1' when DATAIN_IR_DATA_OUT(11 downto 6) = "000000" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "010011" else
	'0';

  -- resource conflict detection logic
  sh_req_STEP_enb_ID <= valid_stage_ID and strchzd_STEP_enb_ID and
  	valid_stage_EXE and strchzd_STEP_enb_EXE;
  sh_req_UA_MUX33_SEL_ID <= valid_stage_ID and strchzd_UA_MUX33_SEL_ID
  	and valid_stage_EXE and strchzd_UA_MUX33_SEL_EXE;

  strchzd_stall_ID <= sh_req_STEP_enb_ID or sh_req_UA_MUX33_SEL_ID;

  resconf_solved_ID <= prev_strchzd_stall_ID and not strchzd_stall_ID;
  ...
  decout_ctrl_word_ID(120 downto 120) <= 
	"1" when decoded_step = '1' else 
	"0";
  -- UA_MUX03.SEL:
  decout_ctrl_word_ID(119 downto 118) <= 
	...
	"00" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_LH = '1' or decoded_LW = '1' or decoded_MMAXS = '1' or
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_SB = '1' or decoded_SH = '1' or
  	decoded_SUB = '1' or decoded_SUBI = '1' or decoded_SW = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' else
	"00";
  -- UA_MUX04.SEL:
  decout_ctrl_word_ID(117 downto 116) <= 
	...
	"00" when decoded_ADD = '1' or decoded_AND = '1' or decoded_EEQ = '1'
  	...
  	decoded_MMAXS = '1' or decoded_NAND = '1' or decoded_NOR = '1' or
  	decoded_OR = '1' or decoded_SUB = '1' or decoded_XOR = '1' else
	"00";
  -- UA_MUX05.SEL:
  decout_ctrl_word_ID(115 downto 115) <= 
	...
	"0";
  -- UA_MUX09.SEL:
  decout_ctrl_word_ID(114 downto 112) <= 
	...
	"000" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	...
  	decoded_LLS = '1' or decoded_LRS = '1' or decoded_MMAX = '1' or
  	decoded_MMAXS = '1' or decoded_MOD = '1' or decoded_MODU = '1' or
  	decoded_MUL = '1' or decoded_NAND = '1' or decoded_NOR = '1' or
  	decoded_OR = '1' or decoded_SUB = '1' or decoded_XOR = '1' else
	"000";
  -- UA_MUX11.SEL:
  decout_ctrl_word_ID(111 downto 110) <= 
	...
	"00";
  -- UA_MUX13.SEL:
  decout_ctrl_word_ID(109 downto 108) <= 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  ...
  decout_ctrl_word_ID(107 downto 107) <= 
	...
	"0";
  -- UA_MUX19.SEL:
  decout_ctrl_word_ID(106 downto 105) <= 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LLSI = '1' or decoded_LRSI = '1' or decoded_LSOI = '1'
  	or decoded_ORI = '1' or decoded_SUBI = '1' or decoded_XORI = '1' else
	...
	"00";
  -- UA_MUX21.SEL:
  decout_ctrl_word_ID(104 downto 103) <= 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LB = '1' or decoded_LH = '1' or decoded_LLSI = '1' or
  	decoded_LRSI = '1' or decoded_LSOI = '1' or decoded_LW = '1' or
	...
	"00";
  -- UA_MUX23.SEL:
  decout_ctrl_word_ID(102 downto 100) <= 
	"100" when decoded_clmp = '1' or decoded_pcmdec = '1' or decoded_step
  	= '1' else
	"011" when decoded_lbh = '1' else 
	"010" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"001" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LB = '1' or decoded_LH = '1' or decoded_LLSI = '1' or
  	decoded_LRSI = '1' or decoded_LSOI = '1' or decoded_LW = '1' or
  	decoded_ORI = '1' or decoded_SUBI = '1' or decoded_XORI = '1' or
  	decoded_lstep = '1' else
	"000" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	or decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_LLS = '1' or decoded_LRS = '1' or decoded_MMAX = '1' or
  	decoded_MMAXS = '1' or decoded_MOD = '1' or decoded_MODU = '1' or
  	decoded_MUL = '1' or decoded_NAND = '1' or decoded_NOR = '1' or
  	decoded_OR = '1' or decoded_SUB = '1' or decoded_XOR = '1' or
  	decoded_addidx = '1' else
	"000";
  -- UA_MUX24.SEL:
  decout_ctrl_word_ID(99 downto 98) <= 
	"10" when decoded_MMAX = '1' or decoded_MMAXS = '1' else 
	"01" when decoded_step = '1' else 
	"00" when decoded_lbh = '1' else 
	"00";
  -- UA_MUX27.SEL:
  decout_ctrl_word_ID(97 downto 97) <= 
	...
	"0";
  -- UA_MUX30.SEL:
  decout_ctrl_word_ID(96 downto 94) <= 
	"101" when decoded_lbh = '1' or decoded_step = '1' else 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' else 
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  	or decoded_SH = '1' or decoded_SW = '1' or decoded_clmp = '1' or
  	decoded_pcmdec = '1' else
	"001" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_BRNZ = '1' or decoded_BRZ = '1' or decoded_LB = '1' or
  	decoded_LH = '1' or decoded_LLSI = '1' or decoded_LRSI = '1' or
  	decoded_LSOI = '1' or decoded_LW = '1' or decoded_ORI = '1' or
  	decoded_SUBI = '1' or decoded_XORI = '1' or decoded_lstep = '1' else
	"000" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	or decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_LLS = '1' or decoded_LRS = '1' or decoded_MMAX = '1' or
	...
	"000";
  -- UA_MUX31.SEL:
  decout_ctrl_word_ID(93 downto 92) <= 
	"11" when decoded_clmp = '1' or decoded_pcmdec = '1' else 
	"10" when decoded_step = '1' else 
  ...
  decout_ctrl_word_ID(91 downto 91) <= 
	"1" when decoded_clmp = '1' or decoded_pcmdec = '1' else 
	"0" when decoded_step = '1' else 
	"0";
  -- UA_MUX33.SEL:
  ...
  decout_ctrl_word_ID(89 downto 89) <= 
	"1" when decoded_addidx = '1' else 
	"0" when decoded_step = '1' else 
	"0";
  decout_ctrl_word_ID(88) <= 
	'1' when decoded_step = '1' else 
	'0';
  decout_ctrl_word_ID(87) <= 
	'1' when decoded_step = '1' else 
	'0';
  -- ALU.mode:
  decout_ctrl_word_ID(86 downto 82) <= 
	...
	"01010" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ELTU =
  	'1' or decoded_ENEQ = '1' or decoded_MMAXS = '1' or decoded_SUB = '1'
	...
	"00000";
  -- ALU.cin:
  decout_ctrl_word_ID(81 downto 81) <= 
	"1" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ELTU = '1'
  	or decoded_ENEQ = '1' or decoded_MMAXS = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' else
	...
	"0";
  -- GPR.flag_enb:
  decout_ctrl_word_ID(80 downto 80) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_SUB = '1'
  	or decoded_SUBI = '1' else
	"0";
  -- FWU0.fw1:
  decout_ctrl_word_ID(79 downto 79) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_MMAX = '1' or decoded_MMAXS = '1' or decoded_MOD = '1' or
	...
	"0";
  -- FWU1.fw1:
  decout_ctrl_word_ID(78 downto 78) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	or decoded_ANDI = '1' or decoded_ARS = '1' or decoded_ARSI = '1' or
  	decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  ...
  decout_ctrl_word_ID(75 downto 74) <= 
	...
	"00";
  -- PC.load:
  decout_ctrl_word_ID(73 downto 73) <= 
	"1" when decoded_JP = '1' or decoded_JPL = '1' or decoded_JPR = '1' or
  	decoded_JPRL = '1' or decoded_RETI = '1' else
	"0";
  -- GPR.status_enb:
  decout_ctrl_word_ID(72 downto 72) <= 
	"1" when decoded_RETI = '1' else 
	"0";
  -- EXT8TO32.mode:
  decout_ctrl_word_ID(71 downto 71) <= 
	"1" when decoded_EXBW = '1' else 
	"0";
  -- EXT16TO32A.mode:
  decout_ctrl_word_ID(70 downto 70) <= 
	"1" when decoded_EXHW = '1' else 
	"0";
  -- STEP.enb:
  decout_ctrl_word_ID(69 downto 69) <= 
	"1" when decoded_lstep = '1' else 
	"0";
  -- IDX.enb_new:
  decout_ctrl_word_ID(68 downto 68) <= 
	"1" when decoded_addidx = '1' or decoded_step = '1' else 
	"0";
  -- CLMP.enb:
  decout_ctrl_word_ID(67 downto 67) <= 
	"1" when decoded_clmp = '1' else 
	"0";
  -- PCM.enb_new:
  decout_ctrl_word_ID(66 downto 66) <= 
	"1" when decoded_pcmdec = '1' else 
	"0";
  -- MMX.enb:
  decout_ctrl_word_ID(65 downto 65) <= 
	"1" when decoded_MMAX = '1' else 
	"0";
  -- FWU2.fw1:
  decout_ctrl_word_ID(64 downto 64) <= 
	"1" when decoded_MMAX = '1' or decoded_MMAXS = '1' else 
	"0";
  -- FWU3.fw1:
  decout_ctrl_word_ID(63 downto 63) <= 
	"1" when decoded_MMAX = '1' or decoded_MMAXS = '1' else 
	"0";
  -- UA_MUX00.SEL:
  decout_ctrl_word_ID(62 downto 62) <= 
	"1" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_RETI = '1'
  	else
	"0" when decoded_JP = '1' or decoded_JPL = '1' else 
	"0";
  -- UA_MUX02.SEL:
  decout_ctrl_word_ID(61 downto 61) <= 
	"1" when decoded_lbh = '1' else 
	"0" when decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1' or
  	decoded_SB = '1' or decoded_SH = '1' or decoded_SW = '1' else
	"0";
  -- UA_MUX06.SEL:
  decout_ctrl_word_ID(60 downto 57) <= 
	"1101" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1100" when decoded_MMAXS = '1' else 
	"1011" when decoded_MMAX = '1' else 
	...
	"0000";
  -- UA_MUX08.SEL:
  decout_ctrl_word_ID(56 downto 53) <= 
	"1101" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1100" when decoded_MMAXS = '1' else 
	"1011" when decoded_MMAX = '1' else 
	"1010" when decoded_EXHW = '1' else 
  ...
  decout_ctrl_word_ID(52 downto 52) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_LSOI = '1' or decoded_MMAX = '1' or decoded_MMAXS = '1' or
	...
	"0";
  -- UA_MUX14.SEL:
  decout_ctrl_word_ID(51 downto 48) <= 
	"1101" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1100" when decoded_MMAXS = '1' else 
	"1011" when decoded_MMAX = '1' else 
	"1010" when decoded_EXHW = '1' else 
	...
	"0000";
  -- UA_MUX16.SEL:
  decout_ctrl_word_ID(47 downto 44) <= 
	"1101" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1100" when decoded_MMAXS = '1' else 
	"1011" when decoded_MMAX = '1' else 
	"1010" when decoded_EXHW = '1' else 
  ...
  decout_ctrl_word_ID(43 downto 43) <= 
	...
	"0";
  -- UA_MUX26.SEL:
  decout_ctrl_word_ID(42 downto 38) <= 
	"10001" when decoded_JPL = '1' or decoded_JPRL = '1' or decoded_step =
  	'1' else
	"10000" when decoded_MMAXS = '1' else 
	"01111" when decoded_MMAX = '1' else 
	"01110" when decoded_pcmdec = '1' else 
	"01101" when decoded_clmp = '1' else 
	"01100" when decoded_addidx = '1' else 
	"01011" when decoded_lstep = '1' else 
	"01010" when decoded_EXHW = '1' else 
	"01001" when decoded_EXBW = '1' else 
	"01000" when decoded_ENEQ = '1' else 
	"00111" when decoded_EEQ = '1' else 
	"00110" when decoded_ELTU = '1' else 
	"00101" when decoded_ELT = '1' else 
	"00100" when decoded_ARS = '1' or decoded_ARSI = '1' or decoded_LLS =
  	'1' or decoded_LLSI = '1' or decoded_LRS = '1' or decoded_LRSI = '1'
  	else
	"00011" when decoded_MOD = '1' or decoded_MODU = '1' else 
	"00010" when decoded_DIV = '1' or decoded_DIVU = '1' else 
	"00001" when decoded_MUL = '1' else 
	"00000" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND =
  	'1' or decoded_ANDI = '1' or decoded_LSOI = '1' or decoded_NAND = '1'
  	or decoded_NOR = '1' or decoded_OR = '1' or decoded_ORI = '1' or
  	decoded_SUB = '1' or decoded_SUBI = '1' or decoded_XOR = '1' or
  	decoded_XORI = '1' else
	"00000";
  -- UA_MUX29.SEL:
  decout_ctrl_word_ID(37 downto 36) <= 
	"10" when decoded_MMAXS = '1' else 
	"01" when decoded_MMAX = '1' else 
	"00" when decoded_step = '1' else 
	"00";
  -- UA_MUX33.SEL:
  decout_ctrl_word_ID(35 downto 35) <= 
	"0" when decoded_lstep = '1' else 
	"0";
  -- UA_MUX35.SEL:
  decout_ctrl_word_ID(34 downto 34) <= 
	"1" when decoded_MMAXS = '1' else 
	"0" when decoded_MMAX = '1' else 
	"0";
  -- UA_MUX36.SEL:
  decout_ctrl_word_ID(33 downto 33) <= 
	...
	"0";
  -- UA_MUX37.SEL:
  decout_ctrl_word_ID(32 downto 32) <= 
	"1" when decoded_MMAXS = '1' else 
	"0" when decoded_MMAX = '1' else 
	"0";
  -- UA_MUX38.SEL:
  decout_ctrl_word_ID(31 downto 31) <= 
	"1" when decoded_MMAXS = '1' else 
	"0" when decoded_MMAX = '1' else 
	"0";
  decout_ctrl_word_ID(30) <= 
	'1' when decoded_TRAP = '1' else 
	'0';
  decout_ctrl_word_ID(29) <= 
	'1' when decoded_BRZ = '1' else 
	'0';
  decout_ctrl_word_ID(28) <= 
  ...
  decout_ctrl_word_ID(18 downto 18) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_NOR = '1' or decoded_OR = '1' or decoded_ORI = '1' or
  	decoded_SUB = '1' or decoded_SUBI = '1' or decoded_XOR = '1' or
  	decoded_XORI = '1' or decoded_addidx = '1' or decoded_clmp = '1' or
  	decoded_lbh = '1' or decoded_lstep = '1' or decoded_pcmdec = '1' or
  	decoded_step = '1' else
	"0";
  -- FWU0.fw2:
  ...
  decout_ctrl_word_ID(15 downto 15) <= 
	...
	"0";
  -- DMAU.mode_out:
  decout_ctrl_word_ID(14 downto 13) <= 
	"11" when decoded_LW = '1' or decoded_SW = '1' else 
	"01" when decoded_LH = '1' or decoded_SH = '1' else 
	"00" when decoded_LB = '1' or decoded_SB = '1' or decoded_lbh = '1'
  	else
	"00";
  -- DMAU.ext_out:
  decout_ctrl_word_ID(12 downto 12) <= 
	"1" when decoded_LB = '1' or decoded_LH = '1' or decoded_lbh = '1'
  	else
	"0";
  -- GPR.w_enb1:
  decout_ctrl_word_ID(11 downto 11) <= 
	"1" when decoded_MMAX = '1' or decoded_MMAXS = '1' or decoded_lbh =
  	'1' or decoded_step = '1' else
	"0";
  -- FWU2.fw2:
  decout_ctrl_word_ID(10 downto 10) <= 
	...
	"0";
  -- FWU3.fw2:
  decout_ctrl_word_ID(9 downto 9) <= 
	"1" when decoded_MMAX = '1' or decoded_MMAXS = '1' else 
	"0";
  -- UA_MUX07.SEL:
  decout_ctrl_word_ID(8 downto 8) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	or decoded_ANDI = '1' or decoded_ARS = '1' or decoded_ARSI = '1' or
  	decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  ...
  decout_ctrl_word_ID(7 downto 7) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_LRS = '1' or decoded_LRSI = '1' or decoded_LSOI = '1' or
  	decoded_LW = '1' or decoded_MMAX = '1' or decoded_MMAXS = '1' or
  	decoded_MOD = '1' or decoded_MODU = '1' or decoded_MUL = '1' or
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' else
  ...
  decout_ctrl_word_ID(4 downto 4) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' or decoded_addidx = '1' or
  	decoded_clmp = '1' or decoded_lbh = '1' or decoded_lstep = '1' or
  	decoded_pcmdec = '1' or decoded_step = '1' else
	"0" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"0";
  -- UA_MUX25.SEL:
  decout_ctrl_word_ID(3 downto 2) <= 
	"10" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	or decoded_ANDI = '1' or decoded_ARS = '1' or decoded_ARSI = '1' or
  	decoded_DIV = '1' or decoded_DIVU = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ELTU = '1' or decoded_ENEQ = '1' or
  	decoded_EXBW = '1' or decoded_EXHW = '1' or decoded_JPL = '1' or
  	...
  	decoded_SUB = '1' or decoded_SUBI = '1' or decoded_XOR = '1' or
  	decoded_XORI = '1' or decoded_addidx = '1' or decoded_clmp = '1' or
  	decoded_lstep = '1' or decoded_pcmdec = '1' or decoded_step = '1' else
	"01" when decoded_lbh = '1' else 
	"00" when decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1'
  	else
	"00";
  -- UA_MUX28.SEL:
  decout_ctrl_word_ID(1 downto 1) <= 
	"1" when decoded_MMAX = '1' or decoded_MMAXS = '1' or decoded_step =
  	'1' else
	"0" when decoded_lbh = '1' else 
	"0";
  decout_ctrl_word_ID(0) <= 
	'1' when decoded_LB = '1' or decoded_LH = '1' or decoded_LW = '1' or
  	decoded_SB = '1' or decoded_SH = '1' or decoded_SW = '1' or decoded_lbh
  	= '1' else
	'0';

  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(86 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(18 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(123);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(122);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(121);
  strchzd_STEP_enb_c_inst_ID <= decout_ctrl_word_ID(120);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(119 downto 118);
  decout_UA_MUX04_SEL <= decout_ctrl_word_ID(117 downto 116);
  decout_UA_MUX05_SEL <= decout_ctrl_word_ID(115);
  decout_UA_MUX09_SEL <= decout_ctrl_word_ID(114 downto 112);
  decout_UA_MUX11_SEL <= decout_ctrl_word_ID(111 downto 110);
  decout_UA_MUX13_SEL <= decout_ctrl_word_ID(109 downto 108);
  decout_UA_MUX17_SEL <= decout_ctrl_word_ID(107);
  decout_UA_MUX19_SEL <= decout_ctrl_word_ID(106 downto 105);
  decout_UA_MUX21_SEL <= decout_ctrl_word_ID(104 downto 103);
  decout_UA_MUX23_SEL <= decout_ctrl_word_ID(102 downto 100);
  decout_UA_MUX24_SEL <= decout_ctrl_word_ID(99 downto 98);
  decout_UA_MUX27_SEL <= decout_ctrl_word_ID(97);
  decout_UA_MUX30_SEL <= decout_ctrl_word_ID(96 downto 94);
  decout_UA_MUX31_SEL <= decout_ctrl_word_ID(93 downto 92);
  decout_UA_MUX32_SEL <= decout_ctrl_word_ID(91);
  strchzd_UA_MUX33_SEL_c_inst_ID <= decout_ctrl_word_ID(90);
  decout_UA_MUX34_SEL <= decout_ctrl_word_ID(89);
  strchzd_STEP_enb_ID <= decout_ctrl_word_ID(88);
  strchzd_UA_MUX33_SEL_ID <= decout_ctrl_word_ID(87);
  decout_ALU_mode <= decout_ctrl_word_EXE(86 downto 82);
  decout_ALU_cin <= decout_ctrl_word_EXE(81);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(80);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(79);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(78);
  decout_MUL_mode <= decout_ctrl_word_EXE(77);
  decout_DIV_mode <= decout_ctrl_word_EXE(76);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(75 downto 74);
  decout_PC_load <= decout_ctrl_word_EXE(73);
  decout_GPR_status_enb <= decout_ctrl_word_EXE(72);
  decout_EXT8TO32_mode <= decout_ctrl_word_EXE(71);
  decout_EXT16TO32A_mode <= decout_ctrl_word_EXE(70);
  strchzd_STEP_enb_c_inst_EXE <= decout_ctrl_word_EXE(69);
  decout_IDX_enb_new <= decout_ctrl_word_EXE(68);
  decout_CLMP_enb <= decout_ctrl_word_EXE(67);
  decout_PCM_enb_new <= decout_ctrl_word_EXE(66);
  decout_MMX_enb <= decout_ctrl_word_EXE(65);
  decout_FWU2_fw1 <= decout_ctrl_word_EXE(64);
  decout_FWU3_fw1 <= decout_ctrl_word_EXE(63);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(62);
  decout_UA_MUX02_SEL <= decout_ctrl_word_EXE(61);
  decout_UA_MUX06_SEL <= decout_ctrl_word_EXE(60 downto 57);
  decout_UA_MUX08_SEL <= decout_ctrl_word_EXE(56 downto 53);
  decout_UA_MUX10_SEL <= decout_ctrl_word_EXE(52);
  decout_UA_MUX14_SEL <= decout_ctrl_word_EXE(51 downto 48);
  decout_UA_MUX16_SEL <= decout_ctrl_word_EXE(47 downto 44);
  decout_UA_MUX18_SEL <= decout_ctrl_word_EXE(43);
  decout_UA_MUX26_SEL <= decout_ctrl_word_EXE(42 downto 38);
  decout_UA_MUX29_SEL <= decout_ctrl_word_EXE(37 downto 36);
  strchzd_UA_MUX33_SEL_c_inst_EXE <= decout_ctrl_word_EXE(35);
  decout_UA_MUX35_SEL <= decout_ctrl_word_EXE(34);
  decout_UA_MUX36_SEL <= decout_ctrl_word_EXE(33);
  decout_UA_MUX37_SEL <= decout_ctrl_word_EXE(32);
  decout_UA_MUX38_SEL <= decout_ctrl_word_EXE(31);
  cause_TRAPINT_inst_at_EXE_00 <= decout_ctrl_word_EXE(30);
  branch_inst_at_EXE_0 <= decout_ctrl_word_EXE(29);
  branch_inst_at_EXE_1 <= decout_ctrl_word_EXE(28);
  branch_inst_at_EXE_2 <= decout_ctrl_word_EXE(27);
  multcyc_MUL_start_c0_inst_EXE <= decout_ctrl_word_EXE(26);
  multcyc_DIV_start_c0_inst_EXE <= decout_ctrl_word_EXE(25);
  asgn_PC_load_inst_v0c0_EXE <= decout_ctrl_word_EXE(24);
  asgn_PC_load_inst_v0c1_EXE <= decout_ctrl_word_EXE(23);
  asgn_UA_MUX00_SEL_inst_v0c0_EXE <= decout_ctrl_word_EXE(22);
  asgn_UA_MUX00_SEL_inst_v0c1_EXE <= decout_ctrl_word_EXE(21);
  strchzd_STEP_enb_EXE <= decout_ctrl_word_EXE(20);
  strchzd_UA_MUX33_SEL_EXE <= decout_ctrl_word_EXE(19);
  decout_GPR_w_enb0 <= decout_ctrl_word_WB(18);
  decout_FWU0_fw2 <= decout_ctrl_word_WB(17);
  decout_FWU1_fw2 <= decout_ctrl_word_WB(16);
  decout_DMAU_rw_out <= decout_ctrl_word_WB(15);
  decout_DMAU_mode_out <= decout_ctrl_word_WB(14 downto 13);
  decout_DMAU_ext_out <= decout_ctrl_word_WB(12);
  decout_GPR_w_enb1 <= decout_ctrl_word_WB(11);
  decout_FWU2_fw2 <= decout_ctrl_word_WB(10);
  decout_FWU3_fw2 <= decout_ctrl_word_WB(9);
  decout_UA_MUX07_SEL <= decout_ctrl_word_WB(8);
  decout_UA_MUX12_SEL <= decout_ctrl_word_WB(7);
  decout_UA_MUX15_SEL <= decout_ctrl_word_WB(6);
  decout_UA_MUX20_SEL <= decout_ctrl_word_WB(5);
  decout_UA_MUX22_SEL <= decout_ctrl_word_WB(4);
  decout_UA_MUX25_SEL <= decout_ctrl_word_WB(3 downto 2);
  decout_UA_MUX28_SEL <= decout_ctrl_word_WB(1);
  ...
  resctrl_GPR_w_enb1_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_GPR_w_enb1;
  resctrl_IDX_enb_new_inst <= decout_IDX_enb_new;
  resctrl_CLMP_enb_inst <= decout_CLMP_enb;
  resctrl_PCM_enb_new_inst <= decout_PCM_enb_new;
  resctrl_MMX_enb_inst <= decout_MMX_enb;
  resctrl_FWU2_fw1_inst <= 
	'0' when advance_stage_EXE = '0' else 
	decout_FWU2_fw1;
  resctrl_FWU3_fw1_inst <= 
	'0' when advance_stage_EXE = '0' else 
	decout_FWU3_fw1;
  resctrl_FWU2_fw2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_FWU2_fw2;
  resctrl_FWU3_fw2_inst <= 
	'0' when advance_stage_WB = '0' else 
	decout_FWU3_fw2;
  ...
  resctrl_UA_MUX27_SEL_inst <= decout_UA_MUX27_SEL;
  ...
  resctrl_sh_STEP_enb_inst_EXE <= strchzd_STEP_enb_c_inst_EXE;
  resctrl_sh_STEP_enb_inst_ID <= strchzd_STEP_enb_c_inst_ID;
  resctrl_sh_STEP_enb_inst <= 
	resctrl_sh_STEP_enb_inst_EXE when valid_stage_EXE = '1' and
  	strchzd_STEP_enb_EXE = '1' else
	resctrl_sh_STEP_enb_inst_ID when valid_stage_ID = '1' else 
	'0';
  resctrl_sh_UA_MUX33_SEL_inst_EXE <= strchzd_UA_MUX33_SEL_c_inst_EXE;
  resctrl_sh_UA_MUX33_SEL_inst_ID <= strchzd_UA_MUX33_SEL_c_inst_ID;
  resctrl_sh_UA_MUX33_SEL_inst <= 
	resctrl_sh_UA_MUX33_SEL_inst_EXE when valid_stage_EXE = '1' and
  	strchzd_UA_MUX33_SEL_EXE = '1' else
	resctrl_sh_UA_MUX33_SEL_inst_ID when valid_stage_ID = '1' else 
	'0';
  ...
  CTRLOUT_GPR_W_ENB1 <= 
	...
	'0';
  CTRLOUT_STEP_ENB <= 
	resctrl_sh_STEP_enb_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_IDX_ENB_NEW <= 
	resctrl_IDX_enb_new_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_CLMP_ENB <= 
	resctrl_CLMP_enb_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_PCM_ENB_NEW <= 
	resctrl_PCM_enb_new_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_MMX_ENB <= 
	resctrl_MMX_enb_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU2_FW1 <= 
	resctrl_FWU2_fw1_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU3_FW1 <= 
	resctrl_FWU3_fw1_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU2_FW2 <= 
	resctrl_FWU2_fw2_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_FWU3_FW2 <= 
	resctrl_FWU3_fw2_inst when interrupt_handling = '0' else 
	'0';
  CTRLOUT_MUL_START <= 
  ...
  CTRLOUT_UA_MUX27_SEL <= 
	resctrl_UA_MUX27_SEL_inst when interrupt_handling = '0' else 
	'0';
  ...
  CTRLOUT_UA_MUX33_SEL <= 
	resctrl_sh_UA_MUX33_SEL_inst when interrupt_handling = '0' else 
	'0';
  ...
  CTRLOUT_UA_PREG04_ENB <= pipereg_enb_EXE;
